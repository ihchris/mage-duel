...
export const T = {
  ...
  // Elementos (vívidos e saturados)
  fire:   "#FF5436",
  ice:    "#00D2FF",
  nature: "#10B981",
  arcane: "#D946EF",

  // Raridades (joias arcanas brilhantes)
  common:    "#94A3B8",
  rare:      "#00D2FF",
  epic:      "#C084FC",
  legendary: "#FBBF24",
...
export const I18N = {
  pt: {
    ...
    grimoireSub: "Magias",
    gear: "Equipamentos",
    gearSub: "Atributos & Poder",
    style: "Skins",
    styleSub: "Aparência & Transmog",
    shop: "Loja Arcana",
    pass: "Passe Batalha",
    appearance: "Skins",
    appearanceSub: "Visual & Transmog",
    leaderboard: "Ranking",
    ...
    gearTitle: "Equipamentos & Atributos",
    styleTitle: "Skins & Transmog",
    appearanceTitle: "Skins & Visual",
    ...
    // Pre-Battle Scout & Tactical Loadout
    duelConfrontation: "Confronto de Magos",
    duelMatchmaking: "Pareamento de Duelo",
    loadoutPhase: "Fase de Preparação Tática",
    loadoutTimer: "Tempo de Loadout",
    ...
    highestThreat: "Maior Ameaça",
    timeExpiring: "TEMPO ESGOTANDO!",
    pause: "Pausar",
    resume: "Continuar",
  ...
  en: {
    ...
    gearTitle: "Equipment & Stats",
    styleTitle: "Skins & Transmog",
    appearanceTitle: "Skins & Appearance",
    ...
    loadoutPhase: "Tactical Loadout Phase",
    loadoutTimer: "Loadout Timer",
...
const AURAS = [
  { id: "aura_none",      name: "No aura",                name_pt: "Sem aura",             rarity: "common",    color: null, desc: "—", desc_pt: "—" },
  { id: "aura_ember",     name: "Ember Aura",             name_pt: "Aura de Brasas",       rarity: "rare",      color: "#FF6B3D", fireBonus: 0.08, crit: 3, desc: "+8% Fire dmg · +3% crit", desc_pt: "+8% Dano de Fogo · +3% chance crítica" },
  { id: "aura_frost",     name: "Frost Aura",             name_pt: "Aura Glacial",         rarity: "rare",      color: "#5FC1E8", iceBonus: 0.08, startShield: 6, desc: "+8% Ice dmg · +6 Start Shield", desc_pt: "+8% Dano de Gelo · +6 Escudo Inicial" },
  { id: "aura_void",      name: "Void Aura",              name_pt: "Aura do Vazio",        rarity: "epic",      color: "#B07FF5", arcaneBonus: 0.10, crit: 4, desc: "+10% Arcane dmg · +4% crit", desc_pt: "+10% Dano Arcano · +4% chance crítica" },
  { id: "aura_radiant",   name: "Radiant Aura",           name_pt: "Aura Radiante",        rarity: "legendary", color: "#E8B44F", allDmg: 0.06, regen: 1, maxHpBonus: 6, desc: "+6% all dmg · +1 Mana/turn · +6 Max HP", desc_pt: "+6% dano global · +1 Mana/turno · +6 Vida Máxima" },
  { id: "aura_starlight", name: "Starlight Constellation",name_pt: "Constelação Estelar", rarity: "epic",      color: "#93C5FD", allDmg: 0.06, maxManaBonus: 4, crit: 4, desc: "+6% all dmg · +4 Max Mana · +4% crit", desc_pt: "+6% dano global · +4 Mana Máxima · +4% chance crítica" },
  { id: "aura_bloodmoon", name: "Bloodmoon Eclipse",      name_pt: "Eclipse da Lua de Sangue", rarity: "legendary", color: "#DC2626", allDmg: 0.10, crit: 6, maxHpBonus: 8, desc: "+10% all dmg · +6% crit · +8 Max HP", desc_pt: "+10% dano global · +6% chance crítica · +8 Vida Máxima" },
];
const CAPES = [
  { id: "cape_none",   name: "No cape",           name_pt: "Sem capa",            rarity: "common",    color: null, desc: "—", desc_pt: "—" },
  { id: "cape_travel", name: "Traveler's Cloak",  name_pt: "Manto do Andarilho",   rarity: "rare",      color: "#7A6A52", dark: "#5E5140", maxHpBonus: 8, startShield: 4, desc: "+8 Max HP · +4 Start Shield", desc_pt: "+8 Vida Máxima · +4 Escudo Inicial" },
  { id: "cape_shadow", name: "Shadowweave Drape", name_pt: "Manto das Sombras",   rarity: "rare",      color: "#3D3466", dark: "#28223F", maxHpBonus: 10, dmgReduction: 0.04, desc: "+10 Max HP · -4% dmg taken", desc_pt: "+10 Vida Máxima · -4% dano recebido" },
  { id: "cape_star",   name: "Starweave Mantle",  name_pt: "Manto Estelar",       rarity: "epic",      color: "#8E5FD1", dark: "#5F3F94", maxHpBonus: 12, maxManaBonus: 3, allDmg: 0.05, desc: "+12 Max HP · +3 Max Mana · +5% all dmg", desc_pt: "+12 Vida Máxima · +3 Mana Máxima · +5% dano global" },
  { id: "cape_phoenix",name: "Phoenixwing Cloak", name_pt: "Capa da Fênix",       rarity: "legendary", color: "#E85A3D", dark: "#B03D24", maxHpBonus: 14, fireBonus: 0.08, crit: 4, desc: "+14 Max HP · +8% Fire dmg · +4% crit", desc_pt: "+14 Vida Máxima · +8% Dano de Fogo · +4% chance crítica" },
  { id: "wings_angel", name: "Angel Wings",       name_pt: "Asas Angelicais",     rarity: "legendary", color: "#F5F0E6", dark: "#D9CFC0", maxHpBonus: 16, startShield: 8, dmgReduction: 0.05, desc: "+16 Max HP · +8 Start Shield · -5% dmg taken", desc_pt: "+16 Vida Máxima · +8 Escudo Inicial · -5% dano recebido" },
  { id: "wings_demon", name: "Demon Wings",       name_pt: "Asas Demoníacas",     rarity: "legendary", color: "#4A1F1F", dark: "#240D0D", maxHpBonus: 12, crit: 6, allDmg: 0.06, desc: "+12 Max HP · +6% crit · +6% all dmg", desc_pt: "+12 Vida Máxima · +6% chance crítica · +6% dano global" },
  { id: "wings_phoenix",name: "Phoenix Wings",    name_pt: "Asas da Fênix",       rarity: "legendary", color: "#FF5722", dark: "#991B1B", maxHpBonus: 14, fireBonus: 0.10, crit: 5, desc: "+14 Max HP · +10% Fire dmg · +5% crit", desc_pt: "+14 Vida Máxima · +10% Dano de Fogo · +5% chance crítica" },
  { id: "wings_fae",   name: "Prismatic Fae Wings", name_pt: "Asas Feéricas",     rarity: "legendary", color: "#38BDF8", dark: "#7C3AED", maxHpBonus: 10, maxManaBonus: 4, regen: 1, desc: "+10 Max HP · +4 Max Mana · +1 Mana/turn", desc_pt: "+10 Vida Máxima · +4 Mana Máxima · +1 Mana/turno" },
  { id: "cape_banner", name: "Battle Standard",   name_pt: "Estandarte de Guerra", rarity: "rare",      color: "#854D0E", dark: "#54330A", maxHpBonus: 10, allDmg: 0.05, dmgReduction: 0.03, desc: "+10 Max HP · +5% all dmg · -3% dmg taken", desc_pt: "+10 Vida Máxima · +5% dano global · -3% dano recebido" },
  { id: "cape_fur",    name: "Frostwolf Cloak",   name_pt: "Manto do Lobo Ártico", rarity: "epic",      color: "#CBD5E1", dark: "#64748B", maxHpBonus: 14, iceBonus: 0.08, dmgReduction: 0.04, desc: "+14 Max HP · +8% Ice dmg · -4% dmg taken", desc_pt: "+14 Vida Máxima · +8% Dano de Gelo · -4% dano recebido" },
  { id: "cape_void",   name: "Void Tear Mantle",  name_pt: "Rasgão do Vazio",      rarity: "legendary", color: "#581C87", dark: "#2E1065", maxHpBonus: 16, arcaneBonus: 0.08, crit: 5, desc: "+16 Max HP · +8% Arcane dmg · +5% crit", desc_pt: "+16 Vida Máxima · +8% Dano Arcano · +5% chance crítica" },
];
const ROBES = [
...
const OFFHANDS = [
  { id: "offhand_none",      name: "Empty Hand",      name_pt: "Mão Livre",           rarity: "common",    color: null, startShield: 2, desc: "+2 Start Shield · Free hand for quick warding", desc_pt: "+2 Escudo Inicial · Mão livre para barreiras rápidas" },
...
const PETS = [
  { id: "pet_none",     name: "No companion",    name_pt: "Sem mascote",          rarity: "common",    kind: null, desc: "—", desc_pt: "—" },
  { id: "pet_imp",      name: "Ember Imp",       name_pt: "Diabrete das Chamas",  rarity: "rare",      kind: "imp",      color: "#FF6B3D", dark: "#C4451D", light: "#FFB27A", crit: 3, fireBonus: 0.04, desc: "+3% crit chance · +4% fire damage", desc_pt: "+3% chance crítica · +4% dano de fogo" },
  { id: "pet_sprite",   name: "Frost Sprite",    name_pt: "Fada Glacial",         rarity: "rare",      kind: "sprite",   color: "#5FC1E8", dark: "#3A8FBD", light: "#D6F3FF", startShield: 4, iceBonus: 0.04, desc: "+4 start shield · +4% ice damage", desc_pt: "+4 escudo inicial · +4% dano de gelo" },
  { id: "pet_fox",      name: "Leaf Fox",        name_pt: "Raposa das Folhas",    rarity: "epic",      kind: "fox",      color: "#72C063", dark: "#4F8F45", light: "#DCF0C8", hpBonus: 6, natureBonus: 0.04, desc: "+6 Max HP · +4% nature damage", desc_pt: "+6 vida máxima · +4% dano de natureza" },
  { id: "pet_wisp",     name: "Star Wisp",       name_pt: "Fogo-Fátuo Estelar",   rarity: "legendary", kind: "wisp",     color: "#E8B44F", dark: "#B07FF5", light: "#FFF3C4", allDmg: 0.03, crit: 3, desc: "+3% all damage · +3% crit chance", desc_pt: "+3% dano global · +3% chance crítica" },
  { id: "pet_dragon",   name: "Wyrmling",        name_pt: "Draconiano Bebê",      rarity: "legendary", kind: "dragon",   color: "#EF4444", dark: "#991B1B", light: "#FCA5A5", allDmg: 0.03, startShield: 3, desc: "+3% all damage · +3 start shield", desc_pt: "+3% dano global · +3 escudo inicial" },
  { id: "pet_owl",      name: "Arcane Familiar", name_pt: "Coruja Arcana",        rarity: "epic",      kind: "owl",      color: "#6366F1", dark: "#3730A3", light: "#C7D2FE", maxManaBonus: 2, arcaneBonus: 0.04, desc: "+2 Max Mana · +4% arcane damage", desc_pt: "+2 mana máxima · +4% dano arcano" },
  { id: "pet_mushroom", name: "Sporeling",       name_pt: "Cogumelo Esporo",      rarity: "rare",      kind: "mushroom", color: "#10B981", dark: "#047857", light: "#A7F3D0", dmgReduction: 0.03, hpBonus: 4, desc: "-3% damage taken · +4 Max HP", desc_pt: "-3% dano recebido · +4 vida máxima" },
];

const GLOVES = [
  { id: "gloves_bare",    name: "Stylized Mage Hands", name_pt: "Mãos Despidas",       rarity: "common",    maxManaBonus: 2, desc: "+2 Max Mana · Clean natural grip", desc_pt: "+2 Mana Máxima · Destreza e foco natural" },
...
function computeDamage(skill, atk, def, comboMult = 1, bonusFlat = 0) {
  ...
  if (atk.pet?.allDmg) mult *= 1 + atk.pet.allDmg;
  if (skill.el === "fire" && atk.pet?.fireBonus) mult *= 1 + atk.pet.fireBonus;
  ...
  // Cape Gear offensive bonuses
  if (atk.capeGear) {
    if (atk.capeGear.allDmg) mult *= 1 + atk.capeGear.allDmg;
    if (skill.el === "fire" && atk.capeGear.fireBonus) mult *= 1 + atk.capeGear.fireBonus;
    if (skill.el === "ice" && atk.capeGear.iceBonus) mult *= 1 + atk.capeGear.iceBonus;
    if (skill.el === "nature" && atk.capeGear.natureBonus) mult *= 1 + atk.capeGear.natureBonus;
    if (skill.el === "arcane" && atk.capeGear.arcaneBonus) mult *= 1 + atk.capeGear.arcaneBonus;
  }

  // Aura Gear offensive bonuses
  if (atk.auraGear) {
    if (atk.auraGear.allDmg) mult *= 1 + atk.auraGear.allDmg;
    if (skill.el === "fire" && atk.auraGear.fireBonus) mult *= 1 + atk.auraGear.fireBonus;
    if (skill.el === "ice" && atk.auraGear.iceBonus) mult *= 1 + atk.auraGear.iceBonus;
    if (skill.el === "nature" && atk.auraGear.natureBonus) mult *= 1 + atk.auraGear.natureBonus;
    if (skill.el === "arcane" && atk.auraGear.arcaneBonus) mult *= 1 + atk.auraGear.arcaneBonus;
  }
  ...
  let critChance = BASE_CRIT + (atk.staffGear?.crit || 0) + (atk.relic?.crit || 0) + (atk.offhand?.crit || 0) + (atk.pet?.crit || 0)
    ...
    + (atk.capeGear?.crit || 0) + (atk.auraGear?.crit || 0);
  ...
  // Gear Damage Reduction: Robe, Gloves, Boots, Necklace, Cape
  ...
  if (def.capeGear?.dmgReduction) mult *= (1 - def.capeGear.dmgReduction);
  // Defensive Rings
...
function makeMage(name, affinity, skills, staffId, relicId, hatId, auraId, capeId, armorId, petId, robeId, look, offhandId, glovesId, ring1Id = "ring_none", ring2Id = "ring_none", bootsId = "boots_apprentice", necklaceId = "necklace_none") {
  ...
  const capeGear = CAPES.find(c => c.id === capeId && c.id !== "cape_none") || null;
  const auraGear = AURAS.find(a => a.id === auraId && a.id !== "aura_none") || null;
  ...
  let maxHp = MAX_HP + (armor?.maxHpBonus || 0) + (pet?.hpBonus || 0) + (ring1?.maxHpBonus || 0) + (ring2?.maxHpBonus || 0)
    ...
    + (capeGear?.maxHpBonus || 0) + (auraGear?.maxHpBonus || 0);
  ...
  const startShield = (relic?.startShield || 0) + (pet?.startShield || 0) + (ring1?.startShield || 0) + (ring2?.startShield || 0)
    ...
    + (capeGear?.startShield || 0) + (auraGear?.startShield || 0) + (offhandId ? (OFFHANDS.find(o => o.id === offhandId)?.startShield || 0) : 0);
  ...
  const maxMana = MAX_MANA + (pet?.maxManaBonus || 0) + (ring1?.maxManaBonus || 0) + (ring2?.maxManaBonus || 0)
    ...
    + (capeGear?.maxManaBonus || 0) + (auraGear?.maxManaBonus || 0);
...
function calculateMagePowerScore(mage, level = 1) {
  ...
  if (mage.glovesGear) score += RARITY_POWER[mage.glovesGear.rarity] || 6;
  if (mage.bootsGear) score += RARITY_POWER[mage.bootsGear.rarity] || 6;
  if (mage.capeGear && mage.capeGear.id !== "cape_none") score += RARITY_POWER[mage.capeGear.rarity] || 6;
  if (mage.auraGear && mage.auraGear.id !== "aura_none") score += RARITY_POWER[mage.auraGear.rarity] || 6;
...
﻿function WingsAngel({ color, dark }) {
  ...
  const leftWing = (
    <>
      ...
      <g fill={`url(#${uid}_angelFeatherUnder)`} stroke="#B5A48B" strokeWidth={0.8} opacity={0.92}>
      ...
      <path d="M146 200 C 134 146 108 98 76 78 C 70 88 78 110 98 138 C 116 162 136 188 146 200 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M144 198 C 132 148 110 106 82 86" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />
      <path d="M146 200 C 134 146 108 98 76 78" stroke="#FFFFFF" strokeWidth={1.2} fill="none" opacity={0.9} />

      {/* Feather 2 (Upper Primary) */}
      <path d="M136 204 C 112 148 74 108 38 98 C 32 110 46 134 72 164 C 96 190 122 210 136 204 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M134 202 C 112 152 80 118 44 106" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />
      ...
      <path d="M128 214 C 98 168 52 136 16 142 C 12 158 28 182 58 204 C 86 222 114 226 128 214 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M126 212 C 98 172 58 146 24 150" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />
      <path d="M128 214 C 98 168 52 136 16 142" stroke="#FFFFFF" strokeWidth={1.2} fill="none" opacity={0.9} />

      {/* Feather 4 (Mid Primary) */}
      <path d="M124 228 C 92 196 42 180 12 204 C 10 220 28 240 60 248 C 88 252 112 244 124 228 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M122 226 C 92 198 48 186 20 210" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />
      <path d="M124 228 C 92 196 42 180 12 204" stroke="#FFFFFF" strokeWidth={1.2} fill="none" opacity={0.9} />

      {/* Feather 5 (Mid-Lower Primary) */}
      <path d="M126 246 C 96 226 46 224 18 256 C 18 272 38 286 70 286 C 98 282 118 266 126 246 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M124 244 C 96 228 52 230 26 262" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />
      <path d="M126 246 C 96 226 46 224 18 256" stroke="#FFFFFF" strokeWidth={1.2} fill="none" opacity={0.9} />

      {/* Feather 6 (Lower Primary) */}
      <path d="M132 264 C 106 252 58 264 34 310 C 36 324 58 332 86 318 C 110 304 124 284 132 264 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M130 262 C 106 254 64 268 42 314" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <path d="M132 264 C 106 252 58 264 34 310" stroke="#FFFFFF" strokeWidth={1.2} fill="none" opacity={0.9} />

      {/* Feather 7 (Trailing Primary) */}
      <path d="M138 282 C 118 278 78 300 62 356 C 68 366 88 366 110 342 C 126 324 136 302 138 282 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M136 280 C 118 280 84 304 70 358" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.5} strokeLinecap="round" fill="none" />
      ...
      <path d="M144 296 C 132 298 100 324 90 384 C 96 392 112 390 128 366 C 140 348 146 322 144 296 Z" fill={`url(#${uid}_angelFeatherPrimary)`} stroke="#C2B6A3" strokeWidth={1} />
      <path d="M142 294 C 132 302 106 328 98 382" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={1.3} strokeLinecap="round" fill="none" />

      {/* Secondary Feathers (Mid-depth body plumage) */}
      <g fill={`url(#${uid}_angelFeatherSecondary)`} stroke="#C9BFB0" strokeWidth={1}>
      ...
      <g fill={`url(#${uid}_angelFeatherCovert)`} stroke="#D4CABE" strokeWidth={0.9}>
      ...
      <path d="M152 228 C 146 182 128 138 102 114" stroke={`url(#${uid}_angelGoldQuill)`} strokeWidth={3.2} strokeLinecap="round" fill="none" />
  ...
  return (
    <g>
      <defs>
        <radialGradient id={`${uid}_angelHaloGlow`} cx="50%" cy="50%" r="50%">
      ...
      <ellipse cx="200" cy="210" rx="140" ry="110" fill={`url(#${uid}_angelHaloGlow)`} opacity={0.35} />
...
function WingsDemon({ color, dark }) {
  ...
  const leftWing = (
    <>
      ...
      <g stroke="#140306" strokeWidth={1.4}>
        <path d="M102 118 L 38 122 C 40 148 32 168 20 185 L 102 118 Z" fill={`url(#${uid}_demonMembrane)`} />
        <path d="M102 118 L 20 185 C 38 220 36 250 32 275 L 102 118 Z" fill={`url(#${uid}_demonMembrane)`} />
        <path d="M102 118 L 32 275 C 58 310 62 332 70 350 L 102 118 Z" fill={`url(#${uid}_demonMembrane)`} />
        <path d="M102 118 L 70 350 C 104 340 128 320 146 290 L 152 238 Z" fill={`url(#${uid}_demonMembrane)`} />
      </g>
      ...
      <g stroke={`url(#${uid}_demonLavaVein)`} fill="none" opacity={0.88}>
      ...
      {/* Digit 1 (Top strut) */}
      <path d="M102 118 C 76 114 54 116 38 122" stroke={`url(#${uid}_demonBone)`} strokeWidth={3.2} strokeLinecap="round" fill="none" />
      <path d="M102 118 C 76 114 54 116 38 122" stroke={`url(#${uid}_demonBoneHighlight)`} strokeWidth={1.4} strokeLinecap="round" fill="none" />
      <path d="M38 122 C 30 120 24 116 18 114 C 22 122 28 126 38 124 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#0F172A" strokeWidth={0.8} />
      <circle cx="68" cy="116" r={2.2} fill="#22080D" />

      {/* Digit 2 (Main outward strut - Longest reach) */}
      <path d="M102 118 C 66 142 38 162 20 185" stroke={`url(#${uid}_demonBone)`} strokeWidth={3.6} strokeLinecap="round" fill="none" />
      <path d="M102 118 C 66 142 38 162 20 185" stroke={`url(#${uid}_demonBoneHighlight)`} strokeWidth={1.5} strokeLinecap="round" fill="none" />
      <path d="M20 185 C 14 186 10 184 6 182 C 9 190 15 194 20 187 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#0F172A" strokeWidth={0.8} />
      <circle cx="56" cy="152" r={2.4} fill="#22080D" />

      {/* Digit 3 (Mid-lower strut) */}
      <path d="M102 118 C 72 170 48 225 32 275" stroke={`url(#${uid}_demonBone)`} strokeWidth={3.4} strokeLinecap="round" fill="none" />
      <path d="M102 118 C 72 170 48 225 32 275" stroke={`url(#${uid}_demonBoneHighlight)`} strokeWidth={1.4} strokeLinecap="round" fill="none" />
      <path d="M32 275 C 26 280 20 284 16 290 C 23 290 28 286 34 277 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#0F172A" strokeWidth={0.8} />
      <circle cx="64" cy="200" r={2.2} fill="#22080D" />

      {/* Digit 4 (Bottom trailing strut) */}
      <path d="M102 118 C 92 195 82 275 70 350" stroke={`url(#${uid}_demonBone)`} strokeWidth={3.2} strokeLinecap="round" fill="none" />
      <path d="M102 118 C 92 195 82 275 70 350" stroke={`url(#${uid}_demonBoneHighlight)`} strokeWidth={1.3} strokeLinecap="round" fill="none" />
      <path d="M70 350 C 66 360 62 368 58 376 C 66 372 70 364 72 352 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#0F172A" strokeWidth={0.8} />
      <circle cx="84" cy="245" r={2.2} fill="#22080D" />

      {/* Heavy Muscular Forearm Bone (Shoulder to Wrist) */}
      <path d="M152 238 C 146 195 132 152 102 118 C 96 122 108 160 136 244 Z" fill={`url(#${uid}_demonBone)`} stroke="#120306" strokeWidth={1.5} />
      <path d="M150 236 C 144 196 130 155 102 118" stroke={`url(#${uid}_demonBoneHighlight)`} strokeWidth={2.2} strokeLinecap="round" fill="none" />

      {/* Forearm Spikes / Horns */}
      <path d="M128 162 L 120 144 L 134 156 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#120306" strokeWidth={0.8} />
      <path d="M116 138 L 106 122 L 122 132 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#120306" strokeWidth={0.8} />

      {/* Apex Wrist Raptor Talon Hook */}
      <path d="M104 120 C 100 96 88 82 74 78 C 80 92 90 106 100 122 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#0F172A" strokeWidth={1.0} />
      <path d="M102 118 L 110 110 L 108 122 Z" fill={`url(#${uid}_demonClawGrad)`} stroke="#0F172A" strokeWidth={0.8} />
  ...
  return (
    <g>
      <defs>
        <radialGradient id={`${uid}_demonAbyssGlow`} cx="50%" cy="50%" r="50%">
        ...
        <linearGradient id={`${uid}_demonMembrane`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`${uid}_demonBone`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#3A121A" />
          <stop offset="60%" stopColor="#22080D" />
          <stop offset="100%" stopColor="#140306" />
        </linearGradient>
        <linearGradient id={`${uid}_demonBoneHighlight`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#991B1B" />
          <stop offset="70%" stopColor="#65151D" />
          <stop offset="100%" stopColor="#320A0E" />
        </linearGradient>
        <linearGradient id={`${uid}_demonClawGrad`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#F8FAFC" />
          <stop offset="45%" stopColor="#CBD5E1" />
          <stop offset="85%" stopColor="#475569" />
          <stop offset="100%" stopColor="#1E293B" />
        </linearGradient>
        <linearGradient id={`${uid}_demonLavaVein`} x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <ellipse cx="200" cy="220" rx="140" ry="110" fill={`url(#${uid}_demonAbyssGlow)`} opacity={0.45} />
...
function WingsPhoenix({ color, dark }) {
  ...
  const leftWing = (
    <>
      ...
      <g fill={`url(#${uid}_phoenixFlame2)`} stroke="#7F1D1D" strokeWidth={0.8} opacity={0.9}>
      ...
      <path d="M146 200 C 134 146 108 98 76 78 C 70 88 78 110 98 138 C 116 162 136 188 146 200 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M144 198 C 132 148 110 106 82 86" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />

      <path d="M136 204 C 112 148 74 108 38 98 C 32 110 46 134 72 164 C 96 190 122 210 136 204 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M134 202 C 112 152 80 118 44 106" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />

      <path d="M128 214 C 98 168 52 136 16 142 C 12 158 28 182 58 204 C 86 222 114 226 128 214 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M126 212 C 98 172 58 146 24 150" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />

      <path d="M124 228 C 92 196 42 180 12 204 C 10 220 28 240 60 248 C 88 252 112 244 124 228 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M122 226 C 92 198 48 186 20 210" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />

      <path d="M126 246 C 96 226 46 224 18 256 C 18 272 38 286 70 286 C 98 282 118 266 126 246 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M124 244 C 96 228 52 230 26 262" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.8} strokeLinecap="round" fill="none" />

      <path d="M132 264 C 106 252 58 264 34 310 C 36 324 58 332 86 318 C 110 304 124 284 132 264 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M130 262 C 106 254 64 268 42 314" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.6} strokeLinecap="round" fill="none" />

      <path d="M138 282 C 118 278 78 300 62 356 C 68 366 88 366 110 342 C 126 324 136 302 138 282 Z" fill={`url(#${uid}_phoenixFlame1)`} stroke="#B91C1C" strokeWidth={1} />
      <path d="M136 280 C 118 280 84 304 70 358" stroke={`url(#${uid}_phoenixGoldSpine)`} strokeWidth={1.5} strokeLinecap="round" fill="none" />

      {/* Inner Leaping Flame Tongues */}
      <g fill={`url(#${uid}_phoenixFlameCore)`} opacity={0.95}>
  ...
  return (
    <g>
      <defs>
        <radialGradient id={`${uid}_phoenixSunGlow`} cx="50%" cy="50%" r="50%">
        ...
        <linearGradient id={`${uid}_phoenixFlame1`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="25%" stopColor="#FEF08A" />
          <stop offset="60%" stopColor={color || "#F97316"} />
          <stop offset="100%" stopColor={dark || "#DC2626"} />
        </linearGradient>
        <linearGradient id={`${uid}_phoenixFlame2`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FEF08A" />
          <stop offset="40%" stopColor={color || "#F97316"} />
          <stop offset="80%" stopColor="#C2410C" />
          <stop offset="100%" stopColor={dark || "#991B1B"} />
        </linearGradient>
        <linearGradient id={`${uid}_phoenixFlameCore`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="40%" stopColor="#FDE047" />
          <stop offset="100%" stopColor="#EA580C" />
        </linearGradient>
        <linearGradient id={`${uid}_phoenixGoldSpine`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" />
      ...
      {/* Solar Halo Glow */}
      <ellipse cx="200" cy="210" rx="140" ry="110" fill={`url(#${uid}_phoenixSunGlow)`} opacity={0.4} />
...
function WingsFae({ color, dark }) {
  ...
  const leftWing = (
    <>
      ...
      <g>
        <path d="M150 224 C 136 170 105 105 56 74 C 44 86 38 120 44 165 C 50 205 75 235 146 230 Z" fill={`url(#${uid}_faeGlass1)`} stroke="#38BDF8" strokeWidth={1.2} />
        <path d="M144 220 C 132 172 104 116 62 88 C 66 110 74 145 92 180 C 110 210 130 222 144 220 Z" fill="#FFFFFF" opacity={0.38} />

        <g stroke={`url(#${uid}_faeVein)`} strokeWidth={0.9} fill="none" opacity={0.85}>
      ...
      <g>
        <path d="M148 234 C 130 248 100 278 68 335 C 72 344 86 345 106 330 C 130 308 144 275 150 238 Z" fill={`url(#${uid}_faeGlass2)`} stroke="#A855F7" strokeWidth={1.2} />
        <g stroke={`url(#${uid}_faeVein)`} strokeWidth={0.8} fill="none" opacity={0.8}>
  ...
  return (
    <g>
      <defs>
        ...
        <linearGradient id={`${uid}_faeGlass2`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`${uid}_faeVein`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" />
      ...
      {/* Prismatic Fae Aura */}
      <ellipse cx="200" cy="210" rx="140" ry="110" fill={`url(#${uid}_faePrismGlow)`} opacity={0.45} />
...
function MageSprite({ mage, facing, hurt, casting, damageFlash = false, size = 1, easterEgg = null }) {
  const visualRobeId = mage.visualRobeId || mage.robe;
  const robeSkin = ROBES.find(r => r.id === visualRobeId);
  ...
  const visualAuraId = mage.visualAuraId !== undefined ? mage.visualAuraId : mage.aura;
  const aura = AURAS.find(a => a.id === visualAuraId && a.id !== "aura_none");
  const visualHatId = mage.visualHatId !== undefined ? mage.visualHatId : mage.hat;
  const Hat = (visualHatId && visualHatId !== "none") ? HAT_COMPONENTS[visualHatId] : null;
  const visualStaffId = mage.visualStaffId || mage.staffGear?.id;
  const Staff = visualStaffId ? STAFF_COMPONENTS[visualStaffId] : null;
  const Armor = mage.armor ? ARMOR_COMPONENTS[mage.armor.id] : null;
  const visualCapeId = mage.visualCapeId !== undefined ? mage.visualCapeId : (mage.cape ? mage.cape.id : "cape_none");
  const visualCape = CAPES.find(c => c.id === visualCapeId && c.id !== "cape_none");
  const Cape = visualCape ? CAPE_COMPONENTS[visualCape.id] : null;
  const RobeTrim = visualRobeId ? ROBE_COMPONENTS[visualRobeId] : null;
  const visualOffhandId = mage.visualOffhandId !== undefined ? mage.visualOffhandId : (mage.offhand ? mage.offhand.id : "offhand_none");
  const visualOffhand = OFFHANDS.find(o => o.id === visualOffhandId && o.id !== "offhand_none");
  const Offhand = visualOffhand ? (OFFHAND_COMPONENTS[visualOffhand.id] || OffhandGeneric) : null;
  const visualGlovesId = mage.visualGlovesId || mage.gloves;
  const visualBootsId = mage.visualBootsId || mage.boots || mage.bootsId || "boots_apprentice";
  const visualPetId = mage.visualPetId !== undefined ? mage.visualPetId : (mage.pet ? mage.pet.id : "pet_none");
  const petObj = PETS.find(pt => pt.id === visualPetId && pt.id !== "pet_none") || null;
    ...
    >
      ...
      <svg width={w} height={h} viewBox="-20 -25 440 550" style={{ position: "relative", transform: facing === "left" ? "scaleX(-1)" : "none", filter: casting ? "brightness(1.25)" : "none" }}>
        ...
        <g className={hurt || casting ? "" : "mageFloatGroup"}>
          ...
          {Cape && visualCape?.color && <Cape color={visualCape.color} dark={visualCape.dark} />}
          <Base p={p} look={look} hasHat={!!Hat} affinity={mage.affinity} hatId={visualHatId} robeTrim={RobeTrim && <RobeTrim />} armor={Armor && <Armor />} gloves={visualGlovesId} boots={visualBootsId} hasOffhand={!!Offhand} casting={casting} easterEgg={easterEgg} />
          {Staff && (
          ...
          {Offhand && (
            <g className="offhandFloat">
              <Offhand look={look} offhand={visualOffhand} gloves={visualGlovesId} affinity={mage.affinity} />
            </g>
          )}
...
export default function MageDuel() {
  ...
  const [gearSubTab, setGearSubTab] = useState("weapons"); // 'weapons' | 'apparel' | 'mantles_auras' | 'jewelry' | 'relics_pets'
  const [skinSubTab, setSkinSubTab] = useState("transmog"); // 'transmog' | 'body'
  const [skinTransmogCategory, setSkinTransmogCategory] = useState("staff");
  const [skinStaffId, setSkinStaffId] = useState(() => saved?.skinStaffId ?? "default");
  const [skinOffhandId, setSkinOffhandId] = useState(() => saved?.skinOffhandId ?? "default");
  const [skinRobeId, setSkinRobeId] = useState(() => saved?.skinRobeId ?? "default");
  const [skinHatId, setSkinHatId] = useState(() => saved?.skinHatId ?? "default");
  const [skinCapeId, setSkinCapeId] = useState(() => saved?.skinCapeId ?? "default");
  const [skinAuraId, setSkinAuraId] = useState(() => saved?.skinAuraId ?? "default");
  const [skinGlovesId, setSkinGlovesId] = useState(() => saved?.skinGlovesId ?? "default");
  const [skinBootsId, setSkinBootsId] = useState(() => saved?.skinBootsId ?? "default");
  const [skinPetId, setSkinPetId] = useState(() => saved?.skinPetId ?? "default");
  ...
  useEffect(() => {
    const data = {
      ...
      skinStaffId, skinOffhandId, skinRobeId, skinHatId, skinCapeId, skinAuraId, skinGlovesId, skinBootsId, skinPetId,
      owned: [...owned],
      shards,
  ...
  function renderBattleSkillInspectModal() {
    ...
    const isAffinity = s.el === (player?.affinity || affinity);
  ...
  const LOADOUT_DURATION = 25;
  const [loadoutCountdown, setLoadoutCountdown] = useState(LOADOUT_DURATION);
  const [loadoutTimerPaused, setLoadoutTimerPaused] = useState(false);
  const loadoutIntervalRef = useRef(null);

  useEffect(() => {
    if (phase === "scout") {
      setLoadoutCountdown(LOADOUT_DURATION);
      setLoadoutTimerPaused(false);
      if (loadoutIntervalRef.current) clearInterval(loadoutIntervalRef.current);
      loadoutIntervalRef.current = setInterval(() => {
        setLoadoutCountdown(prev => {
          if (prev <= 1) {
            clearInterval(loadoutIntervalRef.current);
            return 0;
          }
          return prev - 1;
        });
  ...
  function toggleLoadoutPause() {
    if (loadoutTimerPaused) {
      setLoadoutTimerPaused(false);
      if (loadoutIntervalRef.current) clearInterval(loadoutIntervalRef.current);
      loadoutIntervalRef.current = setInterval(() => {
        setLoadoutCountdown(prev => {
      ...
      setLoadoutTimerPaused(true);
      if (loadoutIntervalRef.current) clearInterval(loadoutIntervalRef.current);
    }
  }

  function addLoadoutTime(sec = 10) {
    setLoadoutCountdown(prev => Math.min(60, prev + sec));
  }

  function quickEquipOrReplace(id) {
  ...
  const STAR_COLORS = ["#FDE047", "#38BDF8", "#E879F9", "#6EE7B7", "#FFFFFF", "#F472B6"];
  const stars = useMemo(() => Array.from({ length: 22 }, () => ({
    left: Math.random() * 100, top: Math.random() * 100,
    size: rand(1.2, 2.5), delay: rand(0, 4), dur: rand(2.5, 5),
    color: pick(STAR_COLORS),
  })), []);

  const DUST_COLORS = ["#FBBF24", "#38BDF8", "#34D399", "#C084FC", "#F472B6"];
  ...
  useEffect(() => {
    if (phase === "scout" && loadoutCountdown === 0) {
      confirmDuel();
    }
  }, [loadoutCountdown, phase]);

  function confirmDuel() {
    if (loadoutIntervalRef.current) clearInterval(loadoutIntervalRef.current);
    setTab(null);
    clearBattleTimeouts();
    let finalSkills = chosen;
    if (finalSkills.length < 4) {
      const available = [...unlockedSkills].filter(id => !finalSkills.includes(id));
      const needed = 4 - finalSkills.length;
      if (available.length > 0) {
        finalSkills = [...finalSkills, ...available.slice(0, needed)];
        setChosen(finalSkills);
      }
    }
    ...
    p.visualStaffId = skinStaffId !== "default" ? skinStaffId : staffId;
    p.visualOffhandId = skinOffhandId !== "default" ? skinOffhandId : offhandId;
    p.visualRobeId = skinRobeId !== "default" ? skinRobeId : robeId;
    p.visualHatId = skinHatId !== "default" ? skinHatId : hatId;
    p.visualCapeId = skinCapeId !== "default" ? skinCapeId : capeId;
    p.visualAuraId = skinAuraId !== "default" ? skinAuraId : auraId;
    p.visualGlovesId = skinGlovesId !== "default" ? skinGlovesId : glovesId;
    p.visualBootsId = skinBootsId !== "default" ? skinBootsId : bootsId;
    p.visualPetId = skinPetId !== "default" ? skinPetId : petId;
    p.hat = p.visualHatId;
    p.aura = p.visualAuraId;
    p.robe = p.visualRobeId;
    p.gloves = p.visualGlovesId;
    p.boots = p.visualBootsId;
    p.bootsId = p.visualBootsId;
    if (p.visualCapeId) p.cape = CAPES.find(c => c.id === p.visualCapeId && c.id !== "cape_none") || null;
    if (p.visualPetId) p.pet = PETS.find(pt => pt.id === p.visualPetId && pt.id !== "pet_none") || null;
    p.level = mageLevel;
    p.trophies = trophies;
    ...
    const todayMod = getTodayModifier();
    const turnDur = todayMod.id === "swift_duels" ? 14 : TURN_DURATION;
  ...
  const bg = (
    <div style={{ position: "fixed", inset: 0, background: "radial-gradient(ellipse at 50% -10%, #3B2A82 0%, #241A5C 30%, #15103E 65%, #0D092A 100%)", overflow: "hidden", zIndex: 0, contain: "strict", pointerEvents: "none" }}>
      ...
      {/* Colorful Twinkling Stardust */}
      {stars.map((s, i) => (
        <div key={i} className={i >= 12 ? "hidden sm:block" : ""} style={{
          position: "absolute", left: `${s.left}%`, top: `${s.top}%`, width: s.size, height: s.size,
          borderRadius: "50%", background: s.color || "#FDE047",
          boxShadow: `0 0 8px ${s.color || "#FDE047"}`,
          animation: `twinkle ${s.dur}s ease-in-out ${s.delay}s infinite`,
          willChange: "opacity",
        }} />
      ))}

      {/* Floating Arena Mana motes */}
      {dustParticles.map((d, i) => (
        <div key={`d-${i}`} className="hidden sm:block" style={{
          position: "absolute", left: `${d.left}%`, width: d.size, height: d.size,
          borderRadius: "50%", background: d.color || "#FBBF24",
          boxShadow: `0 0 10px ${d.color || "#FBBF24"}`,
  ...
  if (phase === "create") {
    ...
    return (
      <div className="fixed inset-0 w-full h-full safe-all flex items-center justify-center p-0 sm:p-2 md:p-3 overflow-hidden select-none" style={{ color: T.textPrimary }}>
        {styles}{bg}
        {renderAdmToast()}
        ...
        >
          ...
          <div className="hidden md:flex landscape:flex w-full h-full flex-row overflow-hidden">
            ...
            <div className="w-full landscape:w-5/12 md:w-5/12 flex flex-col justify-between border-r border-white/10 p-3.5 sm:p-4 lg:p-5 bg-slate-950/60 flex-shrink-0 overflow-y-auto custom-scrollbar min-h-0">
              <div className="w-full">
                <div className="flex items-center justify-between mb-1 sm:mb-1.5">
                  ...
                  <button
                    onClick={toggleLang}
                    className="px-2 py-0.5 rounded-full text-[10px] sm:text-[11px] font-sans font-bold bg-slate-900/90 border border-white/20 text-zinc-200 hover:border-amber-400/60 hover:text-amber-200 transition-all flex items-center gap-1 shadow-sm active:scale-95"
                ...
                <h1 className="font-serif text-[20px] sm:text-[22px] md:text-[24px] font-bold text-center text-amber-200 drop-shadow-[0_2px_12px_rgba(245,158,11,0.35)]">
                  {t("createTitle")}
                </h1>
                <p className="text-center text-[10.5px] sm:text-[11px] font-sans text-zinc-400 mt-0.5">
                  {t("createSubtitle")}
                </p>
              </div>

              {/* Pedestal with Sprite */}
              <div className="relative flex flex-col items-center justify-center my-1 sm:my-1.5 select-none group">
                <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-30">
                  <div
                    className="w-32 h-32 sm:w-40 sm:h-40 rounded-full blur-2xl transition-all duration-500"
                    style={{ background: `radial-gradient(circle, ${el.color}88 0%, transparent 70%)` }}
                  />
                </div>

                <div className="scale-85 sm:scale-90 md:scale-95 lg:scale-100 flex items-center justify-center transform transition-transform duration-300 hover:scale-105">
                  <MageSprite mage={previewMage} facing="right" size={1.35} />
                </div>

                <div className="w-28 sm:w-32 h-2 sm:h-2.5 rounded-[50%] bg-black/40 blur-sm pointer-events-none mt-0.5" />

                <button
                  onClick={rollRandomLook}
                  className="mt-1 px-2.5 py-0.5 rounded-full text-[10.5px] font-sans font-bold bg-slate-900/90 border border-amber-400/40 text-amber-200 hover:bg-amber-400/20 hover:border-amber-400 transition-all flex items-center gap-1 shadow-md active:scale-95"
                >
                  <span>🎲</span>
              ...
              <div className="w-full space-y-2 sm:space-y-2.5">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <label className="font-serif text-[11px] sm:text-[12px] font-bold text-amber-200">
                      {t("createNameLabel")}
                    </label>
                    <button
                      onClick={rollRandomName}
                      className="text-[10px] sm:text-[11px] font-mono text-amber-400 hover:text-amber-200 flex items-center gap-1 transition-colors"
                      title={t("createRandomName")}
                    >
                      <span>🎲</span>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setMageName(e.target.value.slice(0, 18))}
                      placeholder={t("createNamePlaceholder")}
                      className="w-full rounded-xl border border-white/10 px-3 py-2 font-sans text-[13px] outline-none transition-all bg-slate-950/80 text-zinc-100 placeholder-zinc-500 focus:border-amber-400/60 focus:ring-1 focus:ring-amber-400/40 pr-9"
                    />
                    <button
                      onClick={rollRandomName}
                      className="absolute right-2.5 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-amber-300 transition-colors p-1"
                    ...
                    {Object.entries(ELEMENTS).map(([key, e]) => {
                      ...
                      return (
                        <button
                          key={key}
                          onClick={() => setAffinity(key)}
                          className={`rounded-xl p-1.5 sm:p-2 text-left font-sans transition-all flex items-center gap-1.5 sm:gap-2 border active:scale-95 ${
                        ...
                        >
                          <div
                            className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg flex items-center justify-center font-bold text-xs sm:text-sm flex-shrink-0"
                            style={{ backgroundColor: `${e.color}22`, color: e.color }}
                          >
                            {e.icon}
                          </div>
                          <div className="min-w-0 flex-1">
                            <div className="text-[11px] sm:text-[12px] font-bold truncate" style={{ color: isSel ? e.color : T.textPrimary }}>
                              {getElementName(key, lang)}
                            </div>
                            <div className="text-[8.5px] sm:text-[9px] text-zinc-400 truncate">
                              {perkInfo?.role}
                            </div>
                          </div>
                        </button>
                ...
                <button
                  onClick={() => trimmedName && setPhase("loadout")}
                  disabled={!trimmedName}
                  className="btn-king w-full rounded-xl py-2.5 sm:py-3 font-serif text-[14px] sm:text-[15px] font-bold transition-all shadow-xl flex items-center justify-center gap-2 mt-1"
                >
                  <span>{t("beginJourney")}</span>
                </button>
              </div>
            ...
            <div className="w-full landscape:w-7/12 md:w-7/12 flex flex-col min-h-0 flex-1 bg-slate-900/30 overflow-hidden">
              {/* Sub-Tabs Header */}
              <div className="grid grid-cols-4 gap-1.5 sm:gap-2 p-2.5 sm:p-3 pb-2.5 border-b border-white/10 flex-shrink-0 bg-slate-950/40">
                {[
                  ["body", t("tabBodySkin"), "👤"],
                  ["hair", t("tabHairBeard"), "✂"],
                  ...
                  <button
                    key={tKey}
                    onClick={() => setCreateTab(tKey)}
                    className={`btn-surface rounded-xl py-1.5 px-1 font-mono text-[11px] sm:text-[12px] flex items-center justify-center gap-1.5 transition-all border ${
                      desktopTab === tKey
              ...
              <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-3 sm:p-4 md:p-5 space-y-4 overscroll-contain pb-12">
  ...
  function buildPreviewMage() {
    let activeStaff = skinStaffId !== "default" ? skinStaffId : staffId;
    let activeOffhand = skinOffhandId !== "default" ? skinOffhandId : offhandId;
    let activeRobe = skinRobeId !== "default" ? skinRobeId : robeId;
    let activeHat = skinHatId !== "default" ? skinHatId : hatId;
    let activeCape = skinCapeId !== "default" ? skinCapeId : capeId;
    let activeAura = skinAuraId !== "default" ? skinAuraId : auraId;
    let activeGloves = skinGlovesId !== "default" ? skinGlovesId : glovesId;
    let activeBoots = skinBootsId !== "default" ? skinBootsId : bootsId;
    let activePet = skinPetId !== "default" ? skinPetId : petId;
    ...
    if (previewId) {
      ...
      if (shopEntry) {
        ...
        else if (shopEntry.category === "staff") activeStaff = previewId;
        else if (shopEntry.category === "offhand") activeOffhand = previewId;
        else if (shopEntry.category === "boots") activeBoots = previewId;
      }
    }

    const equippedStaff = STAFFS.find(s => s.id === staffId);
    const equippedOffhand = OFFHANDS.find(o => o.id === offhandId && o.id !== "offhand_none") || null;
    const equippedRobe = ROBES.find(r => r.id === robeId) || null;
    const equippedHat = HATS.find(h => h.id === hatId) || null;
    const equippedGloves = GLOVES.find(g => g.id === glovesId) || null;
    const equippedBoots = BOOTS.find(b => b.id === bootsId) || null;
    const equippedCape = CAPES.find(c => c.id === capeId && c.id !== "cape_none") || null;
    const equippedAura = AURAS.find(a => a.id === auraId && a.id !== "aura_none") || null;
    const equippedPet = PETS.find(p => p.id === petId && p.id !== "pet_none") || null;
    const equippedRelic = RELICS.find(r => r.id === relicId && r.id !== "none") || null;
    const equippedRing1 = findRing(ring1Id);
    const equippedRing2 = findRing(ring2Id);
    const equippedNecklace = findNecklace(necklaceId);

    // Total Combat Stats calculation
    let calculatedMaxHp = MAX_HP + (equippedPet?.hpBonus || 0) + (equippedRing1?.maxHpBonus || 0) + (equippedRing2?.maxHpBonus || 0)
      + (equippedRobe?.maxHpBonus || 0) + (equippedHat?.maxHpBonus || 0) + (equippedBoots?.maxHpBonus || 0) + (equippedNecklace?.maxHpBonus || 0)
      + (equippedCape?.maxHpBonus || 0) + (equippedAura?.maxHpBonus || 0);
    if (staffId === "bloodpact") calculatedMaxHp -= 8;

    const calculatedStartShield = (equippedRelic?.startShield || 0) + (equippedPet?.startShield || 0) + (equippedRing1?.startShield || 0) + (equippedRing2?.startShield || 0)
      + (equippedRobe?.startShield || 0) + (equippedHat?.startShield || 0) + (equippedBoots?.startShield || 0) + (equippedNecklace?.startShield || 0)
      + (equippedCape?.startShield || 0) + (equippedAura?.startShield || 0) + (equippedOffhand?.startShield || 0);

    const calculatedMaxMana = MAX_MANA + (equippedPet?.maxManaBonus || 0) + (equippedRing1?.maxManaBonus || 0) + (equippedRing2?.maxManaBonus || 0)
      + (equippedRobe?.maxManaBonus || 0) + (equippedHat?.maxManaBonus || 0) + (equippedGloves?.maxManaBonus || 0) + (equippedBoots?.maxManaBonus || 0) + (equippedNecklace?.maxManaBonus || 0)
      + (equippedCape?.maxManaBonus || 0) + (equippedAura?.maxManaBonus || 0);

    const calculatedRegen = REGEN + (equippedStaff?.regen || 0) + (equippedRelic?.regen || 0) + (equippedHat?.regen || 0) + (equippedGloves?.regen || 0) + (equippedBoots?.regen || 0) + (equippedCape?.regen || 0) + (equippedAura?.regen || 0) + (equippedNecklace?.regen || 0);

    const calculatedCrit = BASE_CRIT + (equippedStaff?.crit || 0) + (equippedRelic?.crit || 0) + (equippedHat?.crit || 0) + (equippedOffhand?.crit || 0) + (equippedGloves?.crit || 0) + (equippedCape?.crit || 0) + (equippedAura?.crit || 0) + (equippedRing1?.crit || 0) + (equippedRing2?.crit || 0) + (equippedNecklace?.crit || 0) + (equippedPet?.crit || 0);

    const calculatedAllDmg = (equippedStaff?.allDmg || 0) + (equippedOffhand?.allDmg || 0) + (equippedHat?.allDmg || 0) + (equippedRobe?.allDmg || 0) + (equippedGloves?.allDmg || 0) + (equippedBoots?.allDmg || 0) + (equippedCape?.allDmg || 0) + (equippedAura?.allDmg || 0) + (equippedRing1?.allDmg || 0) + (equippedRing2?.allDmg || 0) + (equippedNecklace?.allDmg || 0) + (equippedPet?.allDmg || 0);

    const calculatedDmgReduction = (equippedRobe?.dmgReduction || 0) + (equippedOffhand?.dmgReduction || 0) + (equippedGloves?.dmgReduction || 0) + (equippedBoots?.dmgReduction || 0) + (equippedCape?.dmgReduction || 0) + (equippedNecklace?.dmgReduction || 0) + (equippedPet?.dmgReduction || 0);

    return {
      affinity,
      // Visual fields:
      visualStaffId: activeStaff,
      visualOffhandId: activeOffhand,
      visualRobeId: activeRobe,
      visualHatId: activeHat,
      visualCapeId: activeCape,
      visualAuraId: activeAura,
      visualGlovesId: activeGloves,
      visualBootsId: activeBoots,
      visualPetId: activePet,

      hat: activeHat,
      aura: activeAura,
      robe: activeRobe,
      cape: CAPES.find(c => c.id === activeCape && c.id !== "cape_none") || null,
      pet: PETS.find(p => p.id === activePet && p.id !== "pet_none") || null,
      offhand: OFFHANDS.find(o => o.id === activeOffhand && o.id !== "offhand_none") || null,
      gloves: activeGloves,
      boots: activeBoots,
      bootsId: activeBoots,

      // Equipped Gear (for stats & power score):
      staffGear: equippedStaff,
      offhandGear: equippedOffhand,
      relic: equippedRelic,
      relicId,
      ring1: equippedRing1,
      ring2: equippedRing2,
      ...
      necklaceId,
      robeGear: equippedRobe,
      hatGear: equippedHat,
      glovesGear: equippedGloves,
      bootsGear: equippedBoots,
      capeGear: equippedCape,
      auraGear: equippedAura,
      ...
      shield: calculatedStartShield,
      regen: calculatedRegen,
      crit: calculatedCrit,
      allDmg: calculatedAllDmg,
      dmgReduction: calculatedDmgReduction,

      // Appearance:
      skinTone: skinToneId,
      hairColor: activeHairColor,
      hairStyle: activeHairStyle,
      beardStyle: activeBeardStyle,
      eyeColor: activeEyeColor,
      gender: genderId,
      face: activeFace,
      earrings: activeEarring,
      noseRing: activeNoseRing,
      status: {},
    };
  }
  ...
  function renderBottomNav() {
    ...
    return (
      <nav className="fixed bottom-0 left-0 right-0 z-40 bottom-nav-bar flex items-center justify-around px-2 py-1.5 bottom-safe-padding lg:hidden">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`bottom-nav-item flex flex-col items-center justify-center py-1 px-2 rounded-xl flex-1 max-w-[72px] relative group transition-all duration-150 ${
                item.isMain
                  ? "scale-110 -translate-y-1 bg-gradient-to-b from-amber-500/20 to-amber-900/40 border border-amber-400/60 shadow-[0_0_16px_rgba(245,158,11,0.4)]"
                  : isActive
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center safe-all p-2 sm:p-4 modal-backdrop" onClick={() => setTab(null)}>
        <div className="w-full max-w-md md:max-w-2xl lg:max-w-3xl modal-window max-h-[92dvh] md:max-h-[86vh] flex flex-col overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
          ...
          {(tab === "gear" || tab === "appearance" || tab === "shop") && (
            <div className="flex items-center gap-1 p-1 bg-slate-950/95 border-b border-white/10 px-2 sm:px-3 flex-shrink-0 overflow-x-auto">
              {[
                { id: "gear", label: lang === "pt" ? "Equipamentos" : "Equipment", icon: "🛡️" },
                { id: "appearance", label: lang === "pt" ? "Skins" : "Skins", icon: "🪞" },
            ...
            <div className="flex-shrink-0 w-full bg-slate-950/95 border-b border-white/10 p-2 sm:p-2.5 flex items-center justify-between gap-2.5 relative overflow-hidden shadow-inner">
              ...
              <div className="relative z-10 flex-1 min-w-0 flex flex-col justify-center pr-1 sm:pr-2">
                ...
                <span className="text-[9px] font-sans text-zinc-400 truncate mt-0.5">
                  {tab === "gear" ? (lang === "pt" ? "Equipamentos de combate com atributos reais" : "Combat equipment with active stats") : tab === "appearance" ? (lang === "pt" ? "Skins de itens e aparência do personagem" : "Item transmog skins & character appearance") : (lang === "pt" ? "Itens e cosméticos da Loja" : "Shop items & cosmetics")}
                </span>
              </div>
            </div>
          )}
          ...
          {tab === "gear" && (
            <div>
              {/* Total Combat Attributes Overview Panel */}
              <div className="mb-3 p-2.5 sm:p-3 rounded-2xl bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border border-amber-400/30 shadow-lg">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1.5">
                    <span className="text-amber-300 font-serif font-bold text-xs sm:text-sm flex items-center gap-1">
                      <span>🛡️</span>
                      <span>{lang === "pt" ? "Atributos Totais de Combate" : "Combat Equipment Stats"}</span>
                    </span>
                  </div>
                  <div className="flex items-center gap-1 font-mono text-[11px] font-bold text-amber-300 bg-amber-400/10 px-2 py-0.5 rounded-full border border-amber-400/30">
                    <span>⚡ {calculateMagePowerScore(previewMage, mageLevel)}</span>
                    <span className="text-[9px] text-amber-400/70">{lang === "pt" ? "Poder" : "Power"}</span>
                  </div>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-2">
                  {/* HP Máximo */}
                  <div className="px-2 py-1.5 rounded-xl bg-slate-900/90 border border-emerald-500/20 flex flex-col">
                    <span className="text-[10px] font-mono text-zinc-400 flex items-center gap-1">
                      <span>❤️</span><span>{lang === "pt" ? "Vida Máx." : "Max HP"}</span>
                    </span>
                    <span className="text-xs sm:text-sm font-mono font-bold text-emerald-400">
                      {previewMage.maxHp} HP
                    </span>
                  </div>

                  {/* Mana & Regen */}
                  <div className="px-2 py-1.5 rounded-xl bg-slate-900/90 border border-sky-500/20 flex flex-col">
                    <span className="text-[10px] font-mono text-zinc-400 flex items-center gap-1">
                      <span>💧</span><span>{lang === "pt" ? "Mana / Regen" : "Mana / Regen"}</span>
                    </span>
                    <span className="text-xs sm:text-sm font-mono font-bold text-sky-400">
                      {previewMage.maxMana} <span className="text-[10px] text-teal-300">(+{previewMage.regen}/t)</span>
                    </span>
                  </div>

                  {/* Escudo Inicial & Redução */}
                  <div className="px-2 py-1.5 rounded-xl bg-slate-900/90 border border-amber-500/20 flex flex-col">
                    <span className="text-[10px] font-mono text-zinc-400 flex items-center gap-1">
                      <span>🛡️</span><span>{lang === "pt" ? "Escudo / Defesa" : "Shield / Def"}</span>
                    </span>
                    <span className="text-xs sm:text-sm font-mono font-bold text-amber-400">
                      {previewMage.shield} <span className="text-[10px] text-blue-300">(-{Math.round((previewMage.dmgReduction || 0) * 100)}%)</span>
                    </span>
                  </div>

                  {/* Crítico & Dano Global */}
                  <div className="px-2 py-1.5 rounded-xl bg-slate-900/90 border border-purple-500/20 flex flex-col">
                    <span className="text-[10px] font-mono text-zinc-400 flex items-center gap-1">
                      <span>🎯</span><span>{lang === "pt" ? "Crítico / Dano" : "Crit / Damage"}</span>
                    </span>
                    <span className="text-xs sm:text-sm font-mono font-bold text-purple-400">
                      +{previewMage.crit}% <span className="text-[10px] text-rose-300">(+{Math.round((previewMage.allDmg || 0) * 100)}%)</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-1 sm:gap-1.5 p-1 bg-slate-950/80 rounded-xl border border-white/10 mb-3 flex-shrink-0 overflow-x-auto">
                ...
                <button
                  onClick={() => setGearSubTab("mantles_auras")}
                  className={`flex-1 py-1.5 px-1.5 sm:px-2 rounded-lg text-[11px] sm:text-xs font-sans font-bold transition-all flex items-center justify-center gap-1 whitespace-nowrap cursor-pointer ${
                    gearSubTab === "mantles_auras"
                      ? "bg-amber-500/25 text-amber-300 border border-amber-500/50 shadow-sm"
                      : "text-zinc-400 hover:text-zinc-200 border border-transparent"
                  }`}
                >
                  <span>🪽</span>
                  <span>{lang === "pt" ? "Mantos & Auras" : "Capes & Auras"}</span>
                </button>
                <button
                  onClick={() => setGearSubTab("jewelry")}
                  className={`flex-1 py-1.5 px-1.5 sm:px-2 rounded-lg text-[11px] sm:text-xs font-sans font-bold transition-all flex items-center justify-center gap-1 whitespace-nowrap cursor-pointer ${
                    gearSubTab === "jewelry"
                      ? "bg-amber-500/25 text-amber-300 border border-amber-500/50 shadow-sm"
                      : "text-zinc-400 hover:text-zinc-200 border border-transparent"
                ...
                >
                  <span>📿</span>
                  <span>{lang === "pt" ? "Joias" : "Jewelry"}</span>
                </button>
                <button
                  onClick={() => setGearSubTab("relics_pets")}
                  className={`flex-1 py-1.5 px-1.5 sm:px-2 rounded-lg text-[11px] sm:text-xs font-sans font-bold transition-all flex items-center justify-center gap-1 whitespace-nowrap cursor-pointer ${
                    gearSubTab === "relics_pets"
                      ? "bg-amber-500/25 text-amber-300 border border-amber-500/50 shadow-sm"
                      : "text-zinc-400 hover:text-zinc-200 border border-transparent"
                  }`}
                >
                  <span>🔮</span>
                  <span>{lang === "pt" ? "Relíquias & Pets" : "Relics & Pets"}</span>
                </button>
              </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <p className="font-mono text-sm font-bold" style={{ color: "#E8B44F" }}>
                      🪄 {lang === "pt" ? "Cajado Principal" : "Primary Staff"} <span style={{ color: "#38BDF8" }}>({lang === "pt" ? "dano e canalização elemental" : "dmg & elemental focus"})</span>
                    </p>
                    <span className="text-[10px] font-mono text-zinc-400">{STAFFS.length} {lang === "pt" ? "itens" : "items"}</span>
                  </div>
                  <div className="grid gap-2 mb-5">
                    {STAFFS.map(s => (
                      <RarityCard key={s.id} item={s} selected={staffId === s.id} locked={!owned.has(s.id)} onClick={() => owned.has(s.id) && setStaffId(s.id)} lang={lang} />
                    ))}
                  </div>

                  <div className="flex items-center justify-between mb-2">
                    <p className="font-mono text-sm font-bold" style={{ color: "#E8B44F" }}>
                      📖 {lang === "pt" ? "Mão Secundária / Foco Arcano" : "Offhand Focus"} <span style={{ color: "#38BDF8" }}>({lang === "pt" ? "escudos, dano e crítico" : "shields, dmg & crit"})</span>
                    </p>
                    <span className="text-[10px] font-mono text-zinc-400">{OFFHANDS.length} {lang === "pt" ? "itens" : "items"}</span>
                  </div>
                  <div className="grid gap-2">
                    {OFFHANDS.map(o => (
                      <RarityCard key={o.id} item={o} selected={offhandId === o.id} locked={!owned.has(o.id)} onClick={() => owned.has(o.id) && setOffhandId(o.id)} lang={lang} />
                    ))}
                  </div>
                </div>
              )}
              ...
              {/* 3. Mantles & Auras Sub-tab */}
              {gearSubTab === "mantles_auras" && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <p className="font-mono text-sm font-bold" style={{ color: "#E8B44F" }}>
                      🪽 {lang === "pt" ? "Asas Lendárias & Mantos" : "Legendary Wings & Capes"} <span style={{ color: "#38BDF8" }}>({lang === "pt" ? "vida, dano e redução" : "hp, dmg & reduction"})</span>
                    </p>
                    <span className="text-[10px] font-mono text-zinc-400">{CAPES.length} {lang === "pt" ? "itens" : "items"}</span>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-5">
                    {CAPES.map(c => (
                      <RarityCard key={c.id} item={c} selected={capeId === c.id} locked={!owned.has(c.id)} onClick={() => owned.has(c.id) && setCapeId(c.id)} lang={lang} />
                    ))}
                  </div>

                  <div className="flex items-center justify-between mb-2">
                    <p className="font-mono text-sm font-bold" style={{ color: "#E8B44F" }}>
                      ✨ {lang === "pt" ? "Auras Místicas Elementais" : "Mystic Elemental Auras"} <span style={{ color: "#38BDF8" }}>({lang === "pt" ? "amplificação e bônus de afinidade" : "dmg amp & affinity boost"})</span>
                    </p>
                    <span className="text-[10px] font-mono text-zinc-400">{AURAS.length} {lang === "pt" ? "itens" : "items"}</span>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
                    {AURAS.map(a => (
                      <RarityCard key={a.id} item={a} selected={auraId === a.id} locked={!owned.has(a.id)} onClick={() => owned.has(a.id) && setAuraId(a.id)} lang={lang} />
                    ))}
                  </div>
                </div>
              )}

              {/* 4. Arcane Jewelry Sub-tab (Necklaces & Rings) */}
              {gearSubTab === "jewelry" && (
              ...
              {/* 5. Relics & Companions Sub-tab */}
              {gearSubTab === "relics_pets" && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <p className="font-mono text-sm font-bold" style={{ color: "#E8B44F" }}>
                      🔮 {lang === "pt" ? "Relíquia Maior Arcana" : "Major Arcane Relic"} <span style={{ color: "#38BDF8" }}>({lang === "pt" ? "efeitos passivos poderosos" : "powerful passive triggers"})</span>
                    </p>
                    <span className="text-[10px] font-mono text-zinc-400">{RELICS.length} {lang === "pt" ? "itens" : "items"}</span>
                  </div>
                  <div className="grid gap-2 mb-5">
                    {RELICS.map(r => (
                      <RarityCard key={r.id} item={r} selected={relicId === r.id} locked={!owned.has(r.id)} onClick={() => owned.has(r.id) && setRelicId(r.id)} lang={lang} />
                    ))}
                  </div>

                  <div className="flex items-center justify-between mb-2">
                    <p className="font-mono text-sm font-bold" style={{ color: "#E8B44F" }}>
                      🐾 {lang === "pt" ? "Mascote Companheiro" : "Companion Familiar"} <span style={{ color: "#38BDF8" }}>({lang === "pt" ? "bônus passivo de combate" : "passive combat bonus"})</span>
                    </p>
                    <span className="text-[10px] font-mono text-zinc-400">{PETS.length} {lang === "pt" ? "itens" : "items"}</span>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {PETS.map(pt => (
          ...
          {tab === "appearance" && (() => {
            const TRANSMOG_SLOTS = [
              { id: "staff", label: lang === "pt" ? "Cajados" : "Staffs", icon: "🪄", items: STAFFS, currentSkin: skinStaffId, defaultItem: STAFFS.find(s => s.id === staffId), setSkin: setSkinStaffId, canHide: false },
              { id: "robe", label: lang === "pt" ? "Robes" : "Robes", icon: "🥋", items: ROBES, currentSkin: skinRobeId, defaultItem: ROBES.find(r => r.id === robeId), setSkin: setSkinRobeId, canHide: false },
              { id: "hat", label: lang === "pt" ? "Chapéus" : "Hats", icon: "🎩", items: HATS, currentSkin: skinHatId, defaultItem: HATS.find(h => h.id === hatId), setSkin: setSkinHatId, canHide: true, hideId: "none" },
              { id: "cape", label: lang === "pt" ? "Mantos/Asas" : "Capes", icon: "🪽", items: CAPES.filter(c => c.id !== "cape_none"), currentSkin: skinCapeId, defaultItem: CAPES.find(c => c.id === capeId), setSkin: setSkinCapeId, canHide: true, hideId: "cape_none" },
              { id: "aura", label: lang === "pt" ? "Auras" : "Auras", icon: "✨", items: AURAS.filter(a => a.id !== "aura_none"), currentSkin: skinAuraId, defaultItem: AURAS.find(a => a.id === auraId), setSkin: setSkinAuraId, canHide: true, hideId: "aura_none" },
              { id: "gloves", label: lang === "pt" ? "Luvas" : "Gloves", icon: "🧤", items: GLOVES, currentSkin: skinGlovesId, defaultItem: GLOVES.find(g => g.id === glovesId), setSkin: setSkinGlovesId, canHide: false },
              { id: "boots", label: lang === "pt" ? "Botas" : "Boots", icon: "👢", items: BOOTS, currentSkin: skinBootsId, defaultItem: BOOTS.find(b => b.id === bootsId), setSkin: setSkinBootsId, canHide: false },
              { id: "pet", label: lang === "pt" ? "Mascotes" : "Pets", icon: "🐾", items: PETS.filter(p => p.id !== "pet_none"), currentSkin: skinPetId, defaultItem: PETS.find(p => p.id === petId), setSkin: setSkinPetId, canHide: true, hideId: "pet_none" },
              { id: "offhand", label: lang === "pt" ? "Mão Sec." : "Offhand", icon: "📖", items: OFFHANDS.filter(o => o.id !== "offhand_none"), currentSkin: skinOffhandId, defaultItem: OFFHANDS.find(o => o.id === offhandId), setSkin: setSkinOffhandId, canHide: true, hideId: "offhand_none" },
            ];

            const currentSlot = TRANSMOG_SLOTS.find(s => s.id === skinTransmogCategory) || TRANSMOG_SLOTS[0];

            const handleResetAllTransmogs = () => {
              setSkinStaffId("default");
              setSkinOffhandId("default");
              setSkinRobeId("default");
              setSkinHatId("default");
              setSkinCapeId("default");
              setSkinAuraId("default");
              setSkinGlovesId("default");
              setSkinBootsId("default");
              setSkinPetId("default");
            };
            ...
            return (
              <div className="relative pb-10">
                {/* Header com Abas de Skins e Saldo de Shards */}
                <div className="flex items-center justify-between mb-3 px-3 py-2 rounded-xl bg-slate-900/80 border border-amber-500/30 shadow-md">
                  <div className="flex items-center gap-1.5">
                    <button
                      onClick={() => setSkinSubTab("transmog")}
                      className={`px-3 py-1.5 rounded-lg text-xs font-sans font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                        skinSubTab === "transmog"
                          ? "bg-pink-500/25 text-pink-300 border border-pink-400/50 shadow-sm"
                          : "text-zinc-400 hover:text-zinc-200 border border-transparent"
                      }`}
                    >
                      <span>🎨</span>
                      <span>{lang === "pt" ? "Skins de Itens (Transmog)" : "Item Transmog"}</span>
                    </button>
                    <button
                      onClick={() => setSkinSubTab("body")}
                      className={`px-3 py-1.5 rounded-lg text-xs font-sans font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                        skinSubTab === "body"
                          ? "bg-amber-500/25 text-amber-300 border border-amber-400/50 shadow-sm"
                          : "text-zinc-400 hover:text-zinc-200 border border-transparent"
                    ...
                    >
                      <span>👤</span>
                      <span>{lang === "pt" ? "Corpo & Rosto" : "Body & Face"}</span>
                    </button>
                  </div>
                ...
                {/* 1. Item Transmog Skins Tab */}
                {skinSubTab === "transmog" && (
                  <div>
                    {/* Informative Banner */}
                    <div className="mb-3 p-2.5 rounded-xl bg-slate-950/80 border border-pink-500/30 flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <span className="text-base flex-shrink-0">🪞</span>
                        <div className="text-[11px] font-sans text-zinc-300 leading-snug">
                          <span className="font-bold text-pink-300">{lang === "pt" ? "Sistema de Transmog: " : "Transmog System: "}</span>
                          {lang === "pt"
                            ? "Altere a aparência visual das suas peças sem alterar os atributos de combate!"
                            : "Customize your visual appearance without changing equipment combat stats!"}
                        </div>
                      </div>
                      <button
                        onClick={handleResetAllTransmogs}
                        className="px-2 py-1 rounded-lg text-[10px] font-mono font-bold text-zinc-300 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 flex-shrink-0 whitespace-nowrap cursor-pointer transition-all"
                        title={lang === "pt" ? "Define todos os transmogs como o equipamento real" : "Reset all skins to equipped item looks"}
                      >
                        🔄 {lang === "pt" ? "Resetar Todos" : "Reset All"}
                      </button>
                    </div>

                    {/* Slot Category Selector Pills */}
                    <div className="flex items-center gap-1 p-1 bg-slate-950/90 rounded-xl border border-white/10 mb-3.5 flex-shrink-0 overflow-x-auto">
                      {TRANSMOG_SLOTS.map(slot => (
                        <button
                          key={slot.id}
                          onClick={() => setSkinTransmogCategory(slot.id)}
                          className={`flex-1 py-1 px-1.5 sm:px-2 rounded-lg text-[10.5px] sm:text-xs font-sans font-bold transition-all flex items-center justify-center gap-1 whitespace-nowrap cursor-pointer ${
                            skinTransmogCategory === slot.id
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-1.5">
                        <span className="text-sm">{currentSlot.icon}</span>
                        <span className="font-mono text-sm font-bold text-amber-300">
                          {lang === "pt" ? `Skins para ${currentSlot.label}` : `Skins for ${currentSlot.label}`}
                        </span>
                        <span className="text-[11px] font-mono text-zinc-400">
                          ({currentSlot.items.length} {lang === "pt" ? "modelos" : "models"})
                        </span>
                      </div>
                      {currentSlot.currentSkin !== "default" && (
                        <button
                          onClick={() => currentSlot.setSkin("default")}
                          className="text-[11px] font-mono text-amber-400 hover:text-amber-300 underline cursor-pointer"
                        >
                          {lang === "pt" ? "Restaurar Padrão" : "Use Default"}
                        </button>
                      )}
                    </div>

                    {/* Default Equipment Look Card */}
                    <div className="grid gap-2 mb-3">
                      <button
                        onClick={() => currentSlot.setSkin("default")}
                        className={`card-surface rounded-xl p-3 text-left w-full transition-all duration-150 relative overflow-hidden select-none cursor-pointer flex items-center justify-between border ${
                          currentSlot.currentSkin === "default"
                            ? "border-amber-400 bg-amber-400/15 shadow-[0_0_12px_rgba(245,158,11,0.25)]"
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <div className="font-mono text-xs sm:text-sm font-bold text-white flex items-center gap-1.5">
                              <span>{lang === "pt" ? "Padrão do Equipamento" : "Equipment Default"}</span>
                              {currentSlot.defaultItem && (
                                <span className="text-[10px] text-amber-300 font-mono">
                                  ({currentSlot.defaultItem.name})
                                </span>
                              )}
                            </div>
                            <div className="text-[10px] sm:text-[11px] font-mono text-zinc-400">
                              {lang === "pt"
                                ? "Exibe exatamente o modelo do item atualmente equipado."
                                : "Visually displays whatever item is currently equipped."}
                            </div>
                          </div>
                        </div>
                        {currentSlot.currentSkin === "default" && (
                      ...
                      {/* Hide Visual Card if Slot Supports Hiding */}
                      {currentSlot.canHide && (
                        <button
                          onClick={() => currentSlot.setSkin(currentSlot.hideId)}
                          className={`card-surface rounded-xl p-3 text-left w-full transition-all duration-150 relative overflow-hidden select-none cursor-pointer flex items-center justify-between border ${
                            currentSlot.currentSkin === currentSlot.hideId
                              ? "border-amber-400 bg-amber-400/15 shadow-[0_0_12px_rgba(245,158,11,0.25)]"
                              : "border-slate-800 bg-slate-900/80 hover:border-slate-700"
                          }`}
                        >
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              <div className="font-mono text-xs sm:text-sm font-bold text-white">
                                {lang === "pt" ? "Ocultar Visual / Sem Item" : "Hide Visual / No Display"}
                              </div>
                              <div className="text-[10px] sm:text-[11px] font-mono text-zinc-400">
                                {lang === "pt"
                                  ? "Não exibe nenhum visual para este compartimento (atributos 100% mantidos)."
                                  : "Hides the visual display of this slot (combat stats are 100% kept)."}
                              </div>
                            </div>
                          </div>
                          {currentSlot.currentSkin === currentSlot.hideId && (
                            <span className="text-xs font-mono font-bold px-2 py-0.5 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/40">
                              ✓ {lang === "pt" ? "Oculto" : "Hidden"}
                            </span>
                          )}
                        </button>
                      )}
                    ...
                    {/* All Available Models for Current Slot */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4">
                      {currentSlot.items.map(item => {
                        const isUnlocked = owned.has(item.id);
                        const isEquippedSkin = currentSlot.currentSkin === item.id;
                        const r = RARITY[item.rarity] || { color: T.common, label: "Comum" };
                        const shopEntry = SHOP_ITEMS.find(si => si.id === item.id);
                        const isPreviewing = appearancePreviewItem === item.id;
                        ...
                        return (
                          <div
                            ...
                            onClick={() => {
                              if (isUnlocked) {
                                currentSlot.setSkin(item.id);
                              } else {
                                setAppearancePreviewItem(item.id);
                              }
                            }}
                            className={`card-surface rounded-xl p-2.5 text-left w-full transition-all duration-150 relative overflow-hidden select-none cursor-pointer flex flex-col justify-between border ${
                              isEquippedSkin
                                ? "border-amber-400 bg-amber-400/15 shadow-[0_0_12px_rgba(245,158,11,0.25)] ring-1 ring-amber-400/50"
                                : isPreviewing
                                ? "border-sky-400 bg-sky-400/20 shadow-[0_0_12px_rgba(56,189,248,0.3)] ring-1 ring-sky-400/50"
                                : !isUnlocked
                                ? "border-slate-800 bg-slate-900/60 opacity-80 hover:border-slate-700"
                                : "border-slate-800 bg-slate-900/80 hover:border-slate-700 hover:bg-slate-900"
                            }`}
                          >
                            <div className="flex items-center justify-between mb-1 gap-1">
                              <span className="font-mono text-xs sm:text-sm font-bold text-white truncate flex items-center gap-1">
                                {!isUnlocked && <span className="text-[11px]">🔒</span>}
                                <span>{(lang === "pt" && item.name_pt) ? item.name_pt : item.name}</span>
                              </span>
                              <span
                                className="text-[10px] font-mono font-bold px-1.5 py-0.2 rounded-full border flex-shrink-0"
                                style={{ borderColor: `${r.color}66`, backgroundColor: `${r.color}18`, color: r.color }}
                              >
                                {r.label}
                              </span>
                            ...
                            <div className="text-[10.5px] font-mono text-zinc-400 leading-snug truncate mb-2">
                              {(lang === "pt" && item.desc_pt) ? item.desc_pt : item.desc}
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-1 border-t border-white/5">
                              {isUnlocked ? (
                                ...
                                >
                                  {isEquippedSkin ? (lang === "pt" ? "✓ Skin Ativa" : "✓ Active Skin") : (lang === "pt" ? "Usar Skin" : "Use Skin")}
                                </button>
                              ) : (
                                <div className="flex items-center justify-between w-full">
                                  <span className="text-[10px] font-bold text-amber-400 font-mono">
                                    ✦ {shopEntry ? `${shopEntry.price} Shards` : "Bloqueado"}
                                  </span>
                                  <span className="text-[9.5px] font-mono text-sky-300 hover:underline">
                                    {lang === "pt" ? "Provar Skin" : "Preview Skin"} →
                                  </span>
                                </div>
                              )}
                            </div>
                ...
                {/* Floating Preview & 1-Click Purchase Bar */}
  ...
  function renderEnemyGearModal() {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center safe-all p-3 sm:p-4 modal-backdrop" onClick={() => setShowEnemyGearModal(false)}>
        <div className="w-full max-w-lg modal-window p-4 sm:p-5 max-h-[90vh] overflow-y-auto custom-scrollbar shadow-2xl flex flex-col justify-between" onClick={e => e.stopPropagation()}>
          <div>
            {/* Header */}
            <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl bg-slate-900 border border-white/15 shadow-inner">
                  🔍
                </div>
                <div>
                  <h2 className="font-serif text-[17px] sm:text-[19px] font-bold text-amber-200">
                    {lang === "pt" ? `Equipamentos de ${enemy.name}` : `${enemy.name}'s Equipment`}
                  </h2>
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-[10.5px] font-mono font-bold flex items-center gap-1" style={{ color: foeEl.color }}>
                      <span>{foeEl.icon}</span>
                      <span>{getElementName(enemy.affinity, lang)}</span>
                    </span>
                    {enemy.archetype && (
                      <span
                        className="text-[9.5px] font-mono font-bold px-2 py-0.2 rounded-full border flex items-center gap-1"
                        style={{
                          borderColor: `${enemy.archetype.color}66`,
                          color: enemy.archetype.color,
                          background: `${enemy.archetype.color}15`,
                        }}
                      >
              ...
              <button
                onClick={() => setShowEnemyGearModal(false)}
            ...
            <div className="space-y-2.5">
              {/* 1. Cajado */}
              <div className="card-surface p-3 rounded-xl border flex items-start gap-3" style={{ borderColor: foeStaff ? `${RARITY[foeStaff.rarity]?.color || T.gold}55` : T.borderSubtle }}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-mono text-[13px] font-bold truncate text-zinc-100">
                      {foeStaff?.name || (lang === "pt" ? "Sem Cajado" : "No Staff")}
                    </span>
                    {foeStaff && (
                      <span className="text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-full border" style={{ borderColor: `${RARITY[foeStaff.rarity]?.color}66`, color: RARITY[foeStaff.rarity]?.color, background: `${RARITY[foeStaff.rarity]?.color}15` }}>
                        {RARITY[foeStaff.rarity]?.label}
                      </span>
                    )}
                  </div>
                  {foeStaff && (
                    <div className="mt-1 text-[11px] font-mono text-zinc-300 flex flex-wrap gap-x-3 gap-y-0.5">
                      {foeStaff.elBonus && <span style={{ color: foeEl.color }}>+{Math.round(foeStaff.elBonus * 100)}% Dano {getElementName(foeStaff.el, lang)}</span>}
                      {foeStaff.allDmg && <span className="text-amber-300">+{Math.round(foeStaff.allDmg * 100)}% Dano Geral</span>}
                      {foeStaff.crit && <span className="text-sky-300">+{foeStaff.crit}% Crítico</span>}
                      {foeStaff.regen && <span className="text-emerald-300">+{foeStaff.regen} Mana/Turno</span>}
                    </div>
                  )}
                  {foeStaff?.desc && (
                    <p className="text-[10.5px] font-sans text-zinc-400 mt-1">
                      {(lang === "pt" && foeStaff.desc_pt) ? foeStaff.desc_pt : foeStaff.desc}
                    </p>
                  )}
                </div>
              </div>
              ...
              {/* 2. Relíquia */}
              <div className="card-surface p-3 rounded-xl border flex items-start gap-3" style={{ borderColor: foeRelic ? `${RARITY[foeRelic.rarity]?.color || T.gold}55` : T.borderSubtle }}>
                <div className="w-9 h-9 rounded-lg flex items-center justify-center text-xl flex-shrink-0 bg-white/5 border border-white/10">
                  ✦
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-mono text-[13px] font-bold truncate text-zinc-100">
                      {foeRelic ? foeRelic.name : (lang === "pt" ? "Nenhuma Relíquia" : "No Relic")}
                    </span>
                    {foeRelic && (
                      <span className="text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-full border" style={{ borderColor: `${RARITY[foeRelic.rarity]?.color}66`, color: RARITY[foeRelic.rarity]?.color, background: `${RARITY[foeRelic.rarity]?.color}15` }}>
                        {RARITY[foeRelic.rarity]?.label}
                      </span>
                    )}
                  </div>
                  {foeRelic ? (
                    <>
                      <div className="mt-1 text-[11px] font-mono text-zinc-300 flex flex-wrap gap-x-3 gap-y-0.5">
                        {foeRelic.startShield && <span className="text-sky-300">+{foeRelic.startShield} Escudo Inicial</span>}
                        {foeRelic.regen && <span className="text-emerald-300">+{foeRelic.regen} Mana/Turno</span>}
                        {foeRelic.crit && <span className="text-amber-300">+{foeRelic.crit}% Crítico</span>}
                      </div>
                      <p className="text-[10.5px] font-sans text-zinc-400 mt-1">
                        {(lang === "pt" && foeRelic.desc_pt) ? foeRelic.desc_pt : foeRelic.desc}
                      </p>
                    </>
                  ) : (
                    <p className="text-[10.5px] font-sans text-zinc-500 mt-0.5">
                      {lang === "pt" ? "O oponente não possui relíquia equipada." : "No relic equipped."}
                    </p>
                  )}
                </div>
              </div>

              {/* 3. Item Secundário (Offhand) */}
              <div className="card-surface p-3 rounded-xl border flex items-start gap-3" style={{ borderColor: foeOffhand ? `${RARITY[foeOffhand.rarity]?.color || T.gold}55` : T.borderSubtle }}>
                <div className="w-9 h-9 rounded-lg flex items-center justify-center text-xl flex-shrink-0 bg-white/5 border border-white/10">
                  🛡️
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-mono text-[13px] font-bold truncate text-zinc-100">
                      {foeOffhand ? foeOffhand.name : (lang === "pt" ? "Mão Secundária Livre" : "Empty Offhand")}
                    </span>
                    {foeOffhand && (
                      <span className="text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-full border" style={{ borderColor: `${RARITY[foeOffhand.rarity]?.color}66`, color: RARITY[foeOffhand.rarity]?.color, background: `${RARITY[foeOffhand.rarity]?.color}15` }}>
                        {RARITY[foeOffhand.rarity]?.label}
                      </span>
                    )}
                  </div>
                  {foeOffhand ? (
                    <>
                      <div className="mt-1 text-[11px] font-mono text-zinc-300 flex flex-wrap gap-x-3 gap-y-0.5">
                        {foeOffhand.dmgReduction && <span className="text-emerald-300">-{Math.round(foeOffhand.dmgReduction * 100)}% Dano Recebido</span>}
                        {foeOffhand.allDmg && <span className="text-amber-300">+{Math.round(foeOffhand.allDmg * 100)}% Dano Geral</span>}
                        {foeOffhand.crit && <span className="text-sky-300">{foeOffhand.crit > 0 ? `+${foeOffhand.crit}` : foeOffhand.crit}% Crítico</span>}
                        {foeOffhand.echoChance && <span className="text-purple-300">+{foeOffhand.echoChance}% Chance de Eco</span>}
                      </div>
                      <p className="text-[10.5px] font-sans text-zinc-400 mt-1">
                        {foeOffhand.desc}
                      </p>
                    ...
                    <p className="text-[10.5px] font-sans text-zinc-500 mt-0.5">
                      {lang === "pt" ? "Nenhum tomo, escudo ou orbe na mão secundária." : "No offhand equipped."}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="card-surface p-3 rounded-xl border flex items-start gap-3" style={{ borderColor: foePet ? `${RARITY[foePet.rarity]?.color || T.gold}55` : T.borderSubtle }}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-mono text-[13px] font-bold truncate text-zinc-100">
                      {foePet ? ((lang === "pt" && foePet.name_pt) ? foePet.name_pt : foePet.name) : (lang === "pt" ? "Sem Mascote" : "No Companion")}
                    </span>
                    {foePet && (
                      <span className="text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-full border" style={{ borderColor: `${RARITY[foePet.rarity]?.color}66`, color: RARITY[foePet.rarity]?.color, background: `${RARITY[foePet.rarity]?.color}15` }}>
                        {RARITY[foePet.rarity]?.label}
                      </span>
                    )}
                  </div>
                  {foePet ? (
                    <p className="text-[11px] font-mono text-amber-300/90 mt-1 font-semibold">
                      {(lang === "pt" && foePet.desc_pt) ? foePet.desc_pt : foePet.desc}
                    </p>
                  ) : (
                    <p className="text-[10.5px] font-sans text-zinc-500 mt-0.5">
                      {lang === "pt" ? "O oponente não possui mascote companheiro." : "No companion equipped."}
                    </p>
                  )}
                </div>
              </div>
          ...
          <button
            onClick={() => setShowEnemyGearModal(false)}
            className="btn-surface w-full py-2.5 mt-4 rounded-xl font-mono text-xs font-bold text-zinc-200"
          >
            {lang === "pt" ? "Fechar Inspeção" : "Close Inspection"}
          </button>
        </div>
      </div>
    );
  ...
  if (phase === "loadout") {
    ...
    const previewMage = buildPreviewMage();
    const offhand = findItem(offhandId);
    const hasUnclaimedPass = unclaimedCount > 0;

    return (
      <div className="h-[100dvh] max-h-[100dvh] overflow-hidden sm:min-h-[100dvh] sm:h-auto sm:overflow-y-auto lg:h-[100dvh] lg:max-h-[100dvh] lg:overflow-hidden custom-scrollbar relative flex flex-col items-center justify-between safe-all p-1.5 xs:p-2 sm:p-2.5 md:p-3.5 lg:p-4" style={{ color: T.textPrimary }}>
        {styles}{bg}
        {renderAdmToast()}

        {/* ================= MOBILE VIEW (< 1024px) ================= */}
        <div className="lg:hidden relative z-10 w-full h-full max-h-full flex flex-col justify-between p-0 gap-1 overflow-hidden pb-16 xs:pb-18 max-w-md mx-auto select-none">
          {/* Top Profile Banner (Frankenstein Style) & Currencies */}
          <div className="flex items-center justify-between gap-1.5 pt-1 pb-1 px-1 flex-shrink-0">
            {/* Left: Player Frankenstein Profile Card */}
            <div
              onClick={() => setShowInspectModal(true)}
              className="flex items-center gap-2 px-2 py-1 rounded-2xl bg-gradient-to-r from-indigo-950/90 to-purple-950/80 border border-indigo-400/30 shadow-md cursor-pointer hover:border-amber-400/60 transition-all flex-1 min-w-0"
              title={lang === "pt" ? "Inspecionar Mago" : "Inspect Mage"}
            >
              <div className="relative w-9 h-9 rounded-xl bg-indigo-900/90 border border-amber-400/50 flex items-center justify-center flex-shrink-0 shadow-inner overflow-hidden">
                <span className="text-xl">{el.icon}</span>
                <span className="absolute bottom-0 right-0 px-1 text-[8px] font-black bg-amber-500 text-slate-950 rounded-tl">
                  {mageLevel}
                </span>
              </div>
              <div className="flex flex-col min-w-0 flex-1">
                <div className="flex items-center gap-1 leading-tight">
                  <span className="font-serif font-black text-xs text-amber-200 truncate drop-shadow">
                    {mageName.trim() || "Mage Duel"}
                  </span>
                ...
                {/* XP Bar */}
                <div className="w-full h-1.5 rounded-full bg-slate-950/80 border border-white/10 overflow-hidden mt-1">
                  <div
                    className="h-full rounded-full transition-all duration-300"
                    style={{ width: `${mageLevelInfo.percent}%`, background: "linear-gradient(90deg, #F59E0B, #FDE047)" }}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              {/* Shards Pill with green 3D + */}
              <div
                onClick={() => setTab("shop")}
                className="flex items-center gap-1 pl-2 pr-1 py-0.5 rounded-full bg-indigo-950/90 border border-amber-400/40 shadow cursor-pointer hover:border-amber-400 transition-all"
                title={t("shopTitle")}
              >
                <span className="text-amber-300 font-bold text-xs">✦ {shards}</span>
                <button className="btn-3d-green w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-black p-0 leading-none">
                  +
                </button>
              </div>

              {/* Pass Pill with green 3D + */}
              <div
                onClick={() => setTab("pass")}
                className="flex items-center gap-1 pl-2 pr-1 py-0.5 rounded-full bg-indigo-950/90 border border-rose-400/40 shadow cursor-pointer hover:border-rose-400 transition-all"
                title={t("passTitle")}
              >
                <span className="text-rose-300 font-bold text-xs">🎫 {seasonLevel}</span>
                <button className="btn-3d-green w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-black p-0 leading-none">
                  +
                </button>
              </div>
              ...
              <button
                ...
                className="p-1.5 rounded-xl bg-indigo-950/80 border border-indigo-400/30 text-zinc-300 hover:text-white text-xs"
                title={t("friends")}
              >
                👥
              </button>
          ...
          {/* Center Stage: Mage Diorama with Floating Side Buttons & Trophy Bar */}
          <div className="relative flex-1 min-h-0 flex flex-col items-center justify-center my-auto">
            {/* Floating Side Action Buttons: Left Side */}
            <div className="absolute left-1 sm:left-2 top-1/2 -translate-y-1/2 z-20 flex flex-col gap-2.5 items-center">
              <button
                onClick={() => setShowHeroJourneyModal(true)}
                className="clash-floating-btn"
                title="Jornada Heroica (Missões)"
              >
                {hasClaimableJourney && (
              ...
              <button
                ...
                className="clash-floating-btn"
                style={{ background: "linear-gradient(180deg, #A855F7 0%, #7E22CE 50%, #581C87 100%)", borderColor: "#F3E8FF" }}
                title="Desafios de Mestres / Boss Trials"
              >
                <span className="text-lg">👑</span>
              </button>
              <button
                ...
                className="clash-floating-btn"
                style={{ background: "linear-gradient(180deg, #F97316 0%, #EA580C 50%, #9A3412 100%)", borderColor: "#FFEDD5" }}
                title="Forja Arcana"
              >
                <span className="text-lg">🔨</span>
              </button>
            ...
            <div className="absolute right-1 sm:right-2 top-1/2 -translate-y-1/2 z-20 flex flex-col gap-2.5 items-center">
              <button
                onClick={() => setTab("appearance")}
                className="clash-floating-btn"
                style={{ background: "linear-gradient(180deg, #EC4899 0%, #DB2777 50%, #9D174D 100%)", borderColor: "#FCE7F3" }}
                title="Skins & Transmog"
              >
                <span className="text-lg">🪞</span>
              </button>
              <button
                onClick={() => setTab("gear")}
                className="clash-floating-btn"
                style={{ background: "linear-gradient(180deg, #38BDF8 0%, #0284C7 50%, #075985 100%)", borderColor: "#E0F2FE" }}
              ...
              <button
                ...
                className="clash-floating-btn"
                style={{ background: "linear-gradient(180deg, #10B981 0%, #059669 50%, #064E3B 100%)", borderColor: "#D1FAE5" }}
                title="Alquimia de Poções"
              >
                <span className="text-lg">🧪</span>
              </button>
            </div>
            ...
            <div
              onClick={() => setShowInspectModal(true)}
              className="flex flex-col items-center justify-center cursor-pointer group transform transition-transform group-hover:scale-105 active:scale-95"
            >
              {/* Ambient Elemental Glow */}
              <div className="absolute w-44 h-44 rounded-full blur-2xl opacity-45 pointer-events-none" style={{ background: el.color }} />
              <div className="relative z-10">
                <MageSprite mage={previewMage} facing="right" size={1.65} />
              </div>
              {/* Mystical Dais Pedestal */}
              <div
                className="w-44 h-3.5 rounded-[50%] blur-[2px] mt-0.5"
                style={{
                  background: `radial-gradient(ellipse, ${el.color}EE 0%, rgba(147, 51, 234, 0.6) 45%, transparent 75%)`,
                  boxShadow: `0 0 20px ${el.color}88`,
                }}
              />
            </div>

            {/* Trophy Progress Bar directly under the Pedestal */}
            <div
              onClick={() => setShowLeaderboardModal(true)}
              className="mt-3 w-52 py-1 px-2.5 rounded-full bg-indigo-950/90 border border-amber-400/40 shadow-lg flex items-center gap-2 cursor-pointer hover:border-amber-400 transition-all"
            >
              <span className="text-xs">🏆</span>
              <div className="flex-1">
                <div className="flex justify-between items-center text-[9px] font-mono font-bold leading-none mb-1 text-amber-200">
                  <span>{trophies} Troféus</span>
                  <span className="text-zinc-400">{playerTier?.name_pt || "Arena"}</span>
                </div>
                <div className="w-full h-1.5 rounded-full bg-slate-900 border border-white/10 overflow-hidden">
                  <div
                    ...
                    style={{ width: `${Math.min(100, Math.max(15, (trophies % 1000) / 10))}%` }}
                  />
                </div>
              </div>
            </div>
          ...
          {/* Primary Action Button (Supercell 3D King Battle CTA) */}
          <div className="w-full px-1 py-1 flex-shrink-0 flex flex-col gap-1.5">
            <button
              onClick={() => { setIsTutorial(false); findOpponent(); }}
              disabled={!canFindOpponent}
              className="btn-battle-3d w-full py-3.5 px-4 flex flex-col items-center justify-center"
            >
              <div className="flex items-center gap-2 text-lg sm:text-xl uppercase tracking-wider font-black drop-shadow">
                <span>⚔️</span>
                <span>{t("findDuel")}</span>
              </div>
              <div className="flex items-center gap-1.5 text-[10.5px] font-sans font-bold text-amber-100 drop-shadow">
                <span>{todayMod.icon}</span>
                <span>{todayMod.name}</span>
                <span className="text-amber-200/90">· {canFindOpponent ? (lang === "pt" ? "Ranqueado" : "Ranked") : (lang === "pt" ? "Equipe 4 feitiços" : "Equip 4 spells")}</span>
              </div>
            </button>
          </div>

          {/* 4 Clash Royale Collectible Spell Slots */}
          <div className="w-full px-1 pt-0.5 flex-shrink-0">
            <div className="grid grid-cols-4 gap-1.5">
              {Array.from({ length: 4 }).map((_, i) => {
                const skillId = chosen[i];
                const skill = skillId ? SKILLS.find(s => s.id === skillId) : null;
                const skillEl = skill ? ELEMENTS[skill.el] : null;

                return (
                  <div
                    key={i}
                    onClick={() => setTab("skills")}
                    className="clash-slot-card p-1 flex flex-col items-center justify-between h-[76px] xs:h-[82px]"
                  >
                    {/* Top Status Pill */}
                    <div className="w-full flex items-center justify-center">
                      {skill ? (
                        <span className="text-[7.5px] xs:text-[8px] font-mono font-bold text-emerald-300 px-1 rounded bg-emerald-500/20 border border-emerald-500/40 truncate">
                          ✓ Slot {i + 1}
                        </span>
                      ) : (
                        <span className="text-[7.5px] xs:text-[8px] font-mono font-bold text-amber-300 px-1 rounded bg-amber-500/20 border border-amber-500/40">
                          + Slot {i + 1}
                        </span>
                      )}
                    </div>
                    ...
                    {skill && skillEl ? (
                      <div className="flex flex-col items-center justify-center my-0.5">
                        <span className="text-lg xs:text-xl drop-shadow-[0_0_8px_currentColor]" style={{ color: skillEl.color }}>
                          {skillEl.icon}
                        </span>
                        <span className="text-[8px] xs:text-[9px] font-serif font-bold text-white truncate max-w-[64px] text-center leading-tight">
                          {skill.name}
                        </span>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center justify-center my-auto text-indigo-300/50">
                        <span className="text-base font-black">+</span>
                      </div>
                    )}

                    {/* Bottom Mana / Stat */}
                    <div className="w-full flex items-center justify-center text-[7.5px] xs:text-[8px] font-mono font-bold">
                      {skill ? (
                        <span className="text-sky-300">💧{skill.mana}</span>
                      ) : (
        ...
        {/* ================= DESKTOP WIDESCREEN DASHBOARD (>= 1024px) ================= */}
        <div className="hidden lg:flex relative z-10 flex-col h-full w-full max-w-7xl mx-auto lg:pl-28 py-2 gap-3 select-none">
          {/* Top Global Bar */}
          <header className="w-full flex items-center justify-between px-4 py-2.5 rounded-2xl bg-gradient-to-r from-indigo-950/85 via-slate-900/90 to-indigo-950/85 border border-indigo-400/25 shadow-xl flex-shrink-0">
            {/* Left: Player Profile Frankenstein Header */}
            <div
              onClick={() => setShowInspectModal(true)}
              className="flex items-center gap-3 cursor-pointer group"
              title={lang === "pt" ? "Inspecionar Mago" : "Inspect Mage"}
            >
              <div className="relative w-11 h-11 rounded-2xl bg-indigo-900 border-2 border-amber-400/60 flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform overflow-hidden">
                <span className="text-2xl">{el.icon}</span>
                <span className="absolute bottom-0 right-0 px-1 text-[9px] font-black bg-amber-500 text-slate-950 rounded-tl">
                  {mageLevel}
                </span>
              </div>
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  <h2 className="font-serif font-black text-lg text-amber-200 group-hover:text-amber-100 transition-colors">
                    {mageName.trim() || "Mage Duel"}
                  </h2>
                  <TitleBadge titleId={equippedTitleId} size="xs" lang={lang} onClick={() => setShowHeroJourneyModal(true)} />
                </div>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="text-[11px] font-sans font-semibold text-indigo-200">
                    {getElementName(affinity, lang)} +25%
                  </span>
                  <div className="w-32 h-2 rounded-full bg-slate-950 border border-white/10 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-amber-400 to-yellow-300"
                      style={{ width: `${mageLevelInfo.percent}%` }}
                    />
                  </div>
                  <span className="text-[10px] font-mono text-amber-300/80">
                    {mageLevelInfo.currentInLevel}/{mageLevelInfo.neededForNext} XP
                  </span>
                </div>
              </div>
            </div>

            {/* Right: Currency Pills, Leaderboard, Friends, Settings */}
            <div className="flex items-center gap-3">
              {/* Shards Pill */}
              <div
                onClick={() => setTab("shop")}
                className="flex items-center gap-2 pl-3 pr-1.5 py-1 rounded-full bg-indigo-950/90 border border-amber-400/40 hover:border-amber-400 shadow-md cursor-pointer transition-all hover:scale-105"
                title="Loja Arcana"
              >
                <span className="text-amber-400 font-mono font-bold text-sm">✦ {shards}</span>
                <button className="btn-3d-green w-6 h-6 rounded-full flex items-center justify-center text-xs font-black p-0 leading-none">
                  +
                </button>
              </div>
              ...
              <div
                onClick={() => setTab("pass")}
                className="flex items-center gap-2 pl-3 pr-1.5 py-1 rounded-full bg-indigo-950/90 border border-rose-400/40 hover:border-rose-400 shadow-md cursor-pointer transition-all hover:scale-105"
                title="Passe de Batalha"
              >
                <span className="text-rose-300 font-mono font-bold text-sm">🎫 Nv. {seasonLevel}</span>
                <button className="btn-3d-green w-6 h-6 rounded-full flex items-center justify-center text-xs font-black p-0 leading-none">
                  +
                </button>
              </div>
              ...
              <button
                onClick={() => setShowFriends(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-indigo-950/80 border border-sky-400/30 hover:border-sky-300 text-sky-200 text-xs font-bold transition-all hover:scale-105 cursor-pointer shadow"
                title={t("friends")}
              >
                <span>👥</span>
              ...
              <button
                onClick={() => setShowAdminModal(true)}
                className="p-2 rounded-xl bg-indigo-950/80 border border-indigo-400/30 hover:border-amber-400 text-zinc-200 hover:text-white transition-all hover:scale-105 cursor-pointer shadow"
                title={t("settings")}
              >
                ⚙️
              </button>
          ...
          <div className="grid grid-cols-12 gap-5 flex-1 min-h-0 items-start overflow-y-auto custom-scrollbar pr-1 pb-2">
            {/* ================= LEFT COLUMN: Profile, Modifier, Ranked Stats (col-span-3) ================= */}
            <div className="col-span-3 flex flex-col gap-3.5">
              {/* Active Daily Modifier Card */}
              <div
                onClick={() => setShowDailyModModal(true)}
                className="panel-elevated p-3.5 rounded-2xl border border-amber-400/40 hover:border-amber-300 shadow-lg cursor-pointer transition-all hover:scale-[1.02] group"
              >
                <div className="flex items-center justify-between mb-1.5">
                  <div className="flex items-center gap-2">
                    <span className="text-2xl drop-shadow">{todayMod.icon}</span>
                    <div>
                      <span className="text-[10px] font-mono uppercase tracking-wider text-amber-400/90 font-bold block">
                        {lang === "pt" ? "Modificador Diário" : "Daily Modifier"}
                      </span>
                      <h3 className="font-serif font-bold text-sm text-amber-200 group-hover:text-amber-100 transition-colors">
                        {todayMod.name}
                      </h3>
                    </div>
                  </div>
                  <span className="text-[9px] px-1.5 py-0.5 rounded bg-amber-500/20 border border-amber-400/30 text-amber-200 font-mono font-bold">
                    {todayMod.shortDesc}
                  </span>
                </div>
                <p className="text-[11px] font-sans text-zinc-300 leading-relaxed mb-2.5">
                  {todayMod.desc}
                </p>
                <div className="w-full py-1 text-center text-[10.5px] font-sans font-bold text-amber-300 bg-amber-400/10 rounded-lg border border-amber-400/30 group-hover:bg-amber-400/20 transition-colors">
                  {lang === "pt" ? "Ver Efeitos & Bônus ➔" : "View Effects & Bonuses ➔"}
                </div>
              </div>

              {/* Ranked Stats & Win Streak Widget */}
              <div
                onClick={() => setShowLeaderboardModal(true)}
                className="panel-elevated p-3.5 rounded-2xl border border-indigo-400/30 hover:border-indigo-300 shadow-lg cursor-pointer transition-all hover:scale-[1.02] group"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="font-serif font-bold text-xs text-indigo-200 flex items-center gap-1.5">
                    <span>🏆</span>
                    <span>{lang === "pt" ? "Arena Ranqueada" : "Ranked Arena"}</span>
                  </span>
                ...
                <div className="grid grid-cols-2 gap-2 text-center mb-2.5">
                  <div className="p-2 rounded-xl bg-slate-900/80 border border-white/5">
                    <span className="text-[10px] text-zinc-400 block font-medium">{lang === "pt" ? "Vitórias" : "Wins"}</span>
                    <span className="font-mono font-bold text-base text-emerald-400">{rankedWins}</span>
                  </div>
                  <div className="p-2 rounded-xl bg-slate-900/80 border border-white/5">
                    <span className="text-[10px] text-zinc-400 block font-medium">{lang === "pt" ? "Sequência" : "Streak"}</span>
                    <span className="font-mono font-bold text-base text-amber-400">🔥 {winStreak}</span>
                  </div>
                </div>
                <div className="w-full py-1 text-center text-[10.5px] font-sans font-bold text-indigo-200 bg-indigo-950/60 rounded-lg border border-indigo-400/30 group-hover:bg-indigo-900/60 transition-colors">
                  {lang === "pt" ? "Classificação Completa ➔" : "Full Leaderboard ➔"}
                </div>
              </div>

              {/* Quick Crafting Access: Forge & Alchemy */}
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() => setShowForgeModal(true)}
                  className="p-2.5 rounded-xl bg-gradient-to-b from-orange-950/60 to-slate-900/90 border border-orange-500/40 hover:border-orange-400 text-orange-200 flex flex-col items-center justify-center gap-1 transition-all hover:scale-105 active:scale-95 shadow cursor-pointer"
                >
                  <span className="text-xl">🔨</span>
                  <span className="font-serif text-xs font-bold">{lang === "pt" ? "Forja Arcana" : "Forge"}</span>
                </button>
                <button
                  onClick={() => setShowAlchemyModal(true)}
                  className="p-2.5 rounded-xl bg-gradient-to-b from-purple-950/60 to-slate-900/90 border border-purple-500/40 hover:border-purple-400 text-purple-200 flex flex-col items-center justify-center gap-1 transition-all hover:scale-105 active:scale-95 shadow cursor-pointer"
                >
                  <span className="text-xl">🧪</span>
                  <span className="font-serif text-xs font-bold">{lang === "pt" ? "Alquimia" : "Alchemy"}</span>
                </button>
              </div>
            </div>

            {/* ================= CENTER COLUMN: Grand Arena, 3D King Battle, 4 Clash Cards (col-span-6) ================= */}
            <div className="col-span-6 flex flex-col items-center gap-3">
              {/* Grand Mystical Arena Stage */}
              <div className="relative w-full flex flex-col items-center justify-center py-2">
                {/* Ambient Glow */}
                <div
                  className="absolute w-72 h-72 rounded-full blur-3xl opacity-35 pointer-events-none"
                  style={{ background: `radial-gradient(circle, ${el.color} 0%, rgba(147, 51, 234, 0.4) 60%, transparent 80%)` }}
                />

                {/* Floating Side Action Buttons: Left Side */}
                <div className="absolute left-4 top-1/2 -translate-y-1/2 z-20 flex flex-col gap-3 items-center">
                  <button
                    onClick={() => setShowHeroJourneyModal(true)}
                    className="clash-floating-btn"
                    title="Jornada Heroica (Missões)"
                  ...
                  <button
                    ...
                    className="clash-floating-btn"
                    style={{ background: "linear-gradient(180deg, #A855F7 0%, #7E22CE 50%, #581C87 100%)", borderColor: "#F3E8FF" }}
                    title="Desafios de Mestres Elementais"
                  >
                    <span className="text-xl">👑</span>
                  </button>
                </div>
                ...
                {/* Character Diorama with size 2.3 */}
                <div
                  onClick={() => setShowInspectModal(true)}
                  className="flex flex-col items-center justify-center cursor-pointer group transform transition-transform duration-300 hover:scale-105 active:scale-98"
                  title={lang === "pt" ? "Clique para inspecionar em tela cheia" : "Click to inspect fullscreen"}
                >
                  <div className="relative z-10">
                    <MageSprite mage={previewMage} facing="right" size={2.3} />
                  </div>
                  {/* Elemental Dais Pedestal */}
                  <div
                    className="w-64 h-5 rounded-[50%] blur-[3px] mt-1"
                    style={{
                      background: `radial-gradient(ellipse, ${el.color}EE 0%, rgba(147, 51, 234, 0.6) 45%, transparent 75%)`,
                      boxShadow: `0 0 30px ${el.color}AA`,
                    }}
                  />
                </div>

                {/* Weapon / Offhand Subtitle */}
                <div className="text-center text-xs font-sans text-zinc-300/90 mt-2 font-medium">
                  <span style={{ color: previewMage.staffGear ? RARITY[previewMage.staffGear.rarity]?.color : undefined }}>
                    {previewMage.staffGear?.name}
                  </span>
                  {offhand && <span> · {offhand.name}</span>}
                ...
                {/* Supercell Style Trophy Milestone Bar */}
                <div
                  onClick={() => setShowLeaderboardModal(true)}
                  className="mt-2 w-64 py-1.5 px-3 rounded-full bg-indigo-950/90 border border-amber-400/50 shadow-xl flex items-center gap-2.5 cursor-pointer hover:scale-105 transition-all"
                >
                  <span className="text-sm">🏆</span>
                  <div className="flex-1">
                    <div className="flex justify-between items-center text-[10px] font-mono font-bold leading-none mb-1 text-amber-200">
                      <span>{trophies} Troféus</span>
                      <span className="text-zinc-400">{playerTier?.name_pt || "Arena"}</span>
                    </div>
                    <div className="w-full h-2 rounded-full bg-slate-950 border border-white/10 overflow-hidden">
                      <div
                        className="h-full rounded-full bg-gradient-to-r from-sky-400 via-amber-400 to-yellow-300"
                        style={{ width: `${Math.min(100, Math.max(15, (trophies % 1000) / 10))}%` }}
                      />
                    </div>
                  </div>
              ...
              {/* Giant 3D King Battle CTA Button */}
              <div className="w-full flex items-center gap-3">
                <button
                  onClick={() => { setIsTutorial(false); findOpponent(); }}
                  disabled={!canFindOpponent}
                  className="btn-battle-3d flex-1 py-4 px-6 flex flex-col items-center justify-center gap-0.5"
                >
                  <div className="flex items-center gap-2.5 text-2xl uppercase tracking-wider font-black drop-shadow">
                    <span>⚔️</span>
                    <span>{t("findDuel")}</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs font-sans font-bold text-amber-100 drop-shadow">
                    <span>{todayMod.icon}</span>
                    <span>{todayMod.name}</span>
                    <span className="text-amber-200">· {canFindOpponent ? (lang === "pt" ? "Duelo Ranqueado" : "Ranked Duel") : (lang === "pt" ? "Equipe 4 feitiços" : "Equip 4 spells")}</span>
                  </div>
                </button>
              </div>

              {/* 4 Clash Royale Collectible Spell Cards */}
              <div className="w-full flex flex-col gap-1.5">
                <div className="flex items-center justify-between text-xs px-1">
                  <span className="font-serif font-bold text-amber-300 flex items-center gap-1.5">
                    <span>🔮</span>
                    <span>{lang === "pt" ? "Feitiços de Combate" : "Combat Spells"} ({chosen.length}/{maxSlots})</span>
                  </span>
                  <button
                    onClick={() => setTab("skills")}
                    className="text-xs font-sans font-semibold text-amber-300 hover:text-amber-100 transition-colors flex items-center gap-1 cursor-pointer"
                  >
                  ...
                  {Array.from({ length: 4 }).map((_, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        onClick={() => setTab("skills")}
                        className="clash-slot-card p-2 flex flex-col items-center justify-between h-[105px]"
                        title={skill ? `${skill.name} (Clique para alterar no Grimório)` : "Slot de Feitiço"}
                      >
                        {/* Status Pill */}
                        <div className="w-full flex items-center justify-between px-0.5">
                          <span className="text-[8.5px] font-mono font-bold text-emerald-300 px-1 py-0.2 rounded bg-emerald-500/20 border border-emerald-500/40">
                            Slot {i + 1}
                          </span>
                          {skill && (
                            <span className="text-[9px] font-mono font-bold text-sky-200 px-1 py-0.2 rounded bg-sky-500/25 border border-sky-400/40">
                              💧{skill.mana}
                            </span>
                          )}
                        </div>
                        ...
                        {skill && skillEl ? (
                          <div className="flex flex-col items-center justify-center my-0.5">
                            <span className="text-2xl drop-shadow-[0_0_10px_currentColor]" style={{ color: skillEl.color }}>
                              {skillEl.icon}
                            </span>
                            <span className="text-xs font-serif font-bold text-white truncate max-w-[90px] text-center leading-tight mt-0.5">
                              {skill.name}
                            </span>
                          </div>
                        ) : (
                          <div className="flex flex-col items-center justify-center my-auto text-indigo-300/40">
                            <span className="text-xl font-bold">+</span>
                            <span className="text-[9px] font-sans uppercase tracking-wider">Vazio</span>
                          </div>
                        )}

                        {/* Bottom Stats */}
                        <div className="w-full flex items-center justify-center gap-1.5 text-[8.5px] font-mono font-bold">
                          {skill ? (
                            <>
                            ...
                            <span className="text-zinc-400">Clique para equipar</span>
                          )}
                        </div>
                      </div>
                    );
            ...
            {/* ================= RIGHT COLUMN: Pass Royale, Shop Preview, Training (col-span-3) ================= */}
            <div className="col-span-3 flex flex-col gap-3.5">
              {/* Pass Royale Featured Card */}
              <div className="panel-elevated p-3.5 rounded-2xl border border-rose-400/40 hover:border-rose-300 shadow-lg transition-all hover:scale-[1.02]">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1.5">
                    <span className="text-xl">🎫</span>
                    <span className="font-serif font-bold text-xs text-rose-200">
                      PASSE ARCANO
                    </span>
                  </div>
                  <span className="text-[10px] font-mono font-bold text-rose-300 px-1.5 py-0.5 rounded bg-rose-500/20 border border-rose-500/40">
                    Nv. {seasonLevel}
                  </span>
                </div>
                <p className="text-[11px] font-sans text-zinc-300 leading-relaxed mb-3">
                  {hasUnclaimedPass
                    ? `${unclaimedCount} recompensa(s) pronta(s) para resgate!`
                    : "Desbloqueie feitiços lendários e skins exclusivas nesta temporada."}
                </p>
                <button
                  onClick={() => setTab("pass")}
                  className="btn-3d-green w-full py-2 px-3 text-xs font-black uppercase tracking-wide flex items-center justify-center gap-1.5"
                >
                  <span>{hasUnclaimedPass ? "🎁" : "👑"}</span>
                  <span>{hasUnclaimedPass ? (lang === "pt" ? "Resgatar Prêmios" : "Claim Rewards") : (lang === "pt" ? "Ver Passe" : "View Pass")}</span>
                </button>
              </div>

              {/* Arcane Shop Featured Showcase Card */}
              <div className="panel-elevated p-3.5 rounded-2xl border border-amber-400/40 hover:border-amber-300 shadow-lg transition-all hover:scale-[1.02]">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-mono font-bold text-amber-300 px-1.5 py-0.5 rounded bg-amber-500/20 border border-amber-400/40">
                    {shards} Shards
                  </span>
                </div>
                <p className="text-[11px] font-sans text-zinc-300 leading-relaxed mb-3">
                  Adquira novos cajados, auras míticas e transmogs raros para seu mago.
                </p>
                <button
                  onClick={() => setTab("shop")}
                  className="btn-3d-blue w-full py-2 px-3 text-xs font-black uppercase tracking-wide flex items-center justify-center gap-1.5"
                >
                  <span>✦</span>
                  <span>{lang === "pt" ? "Visitar Loja Arcana" : "Visit Arcane Shop"}</span>
                </button>
              </div>

              {/* Training & Special Modes */}
              <div className="panel-elevated p-3.5 rounded-2xl border border-indigo-400/30 shadow-lg flex flex-col gap-2">
                <span className="font-serif font-bold text-xs text-indigo-200 mb-0.5">
                  {lang === "pt" ? "Campos de Treino" : "Training Grounds"}
                </span>
                <button
                  onClick={startTutorial}
                  className="w-full py-2 px-3 rounded-xl bg-sky-950/50 hover:bg-sky-900/60 border border-sky-400/40 text-sky-200 text-xs font-bold flex items-center justify-between transition-all hover:scale-102 active:scale-98 cursor-pointer"
                >
                  <span className="flex items-center gap-1.5">
                    <span>🎯</span>
                    <span>Espantalho Arcano</span>
                  </span>
                  <span className="text-[10px] text-sky-300">Treinar ➔</span>
                </button>
                <button
                  onClick={() => setShowBossTrialsModal(true)}
                  className="w-full py-2 px-3 rounded-xl bg-purple-950/50 hover:bg-purple-900/60 border border-purple-400/40 text-purple-200 text-xs font-bold flex items-center justify-between transition-all hover:scale-102 active:scale-98 cursor-pointer"
                >
                  <span className="flex items-center gap-1.5">
                    <span>👑</span>
                    <span>Mestres Elementais</span>
                  </span>
                  <span className="text-[10px] text-purple-300">Desafiar ➔</span>
                </button>
              </div>
            </div>
          </div>
  ...
  if (phase === "scout") {
    ...
    const playerCountersEnemy = ELEMENT_ADVANTAGES[affinity] === enemy.affinity;
    const enemyCountersPlayer = ELEMENT_ADVANTAGES[enemy.affinity] === affinity;
    const isSameAffinity = affinity === enemy.affinity;

    // Opponent Threats Analysis
    const highestThreatSpell = [...foeSkills].sort((a, b) => (b.dmg || 0) - (a.dmg || 0))[0];
    const highestHealSpell = [...foeSkills].find(s => (s.heal || 0) > 0);
    const hasHeavyShield = [...foeSkills].some(s => (s.shield || 0) >= 14);

    // Available unequipped unlocked skills for quick-swapping
    const availableSpells = Array.from(unlockedSkills)
      .filter(id => !chosen.includes(id))
      .map(id => SKILLS.find(s => s.id === id))
      .filter(Boolean);

    // Owned gear options for quick-swapping
    const ownedStaffs = STAFFS.filter(s => owned.has(s.id) || s.id === "ashwood");
    const ownedRelics = RELICS.filter(r => owned.has(r.id) || r.id === "none");
    const ownedOffhands = OFFHANDS.filter(o => owned.has(o.id) || o.id === "offhand_none" || o.id === "offhand_tome");

    // Dynamic Tactical Recommendation Tip
    let tacticalTip = "";
    let tacticalTipEn = "";
    if (playerCountersEnemy) {
      tacticalTip = `Vantagem Elemental! Seus feitiços de ${playerEl.ptName || playerEl.name} causam +25% de dano contra ${enemyEl.ptName || enemyEl.name}. Aproveite para equipar seus feitiços mais ofensivos!`;
      tacticalTipEn = `Elemental Advantage! Your ${playerEl.enName || playerEl.name} spells deal +25% bonus damage against ${enemyEl.enName || enemyEl.name}. Equip high offensive spells!`;
    } else if (enemyCountersPlayer) {
      tacticalTip = `Perigo: ${enemyEl.ptName || enemyEl.name} é forte contra ${playerEl.ptName || playerEl.name}! Equipe escudos defensivos ou relíquias protetoras (Ward Sigil / Phoenix) para absorver o impacto.`;
      tacticalTipEn = `Danger: ${enemyEl.enName || enemyEl.name} counters ${playerEl.enName || playerEl.name}! Equip shields or protective relics (Ward Sigil / Phoenix) to absorb the burst.`;
    } else if (highestThreatSpell && highestThreatSpell.dmg >= 22) {
      const spellLabel = (lang === "pt" && highestThreatSpell.name_pt) ? highestThreatSpell.name_pt : highestThreatSpell.name;
      tacticalTip = `Cuidado com "${spellLabel}" (${highestThreatSpell.dmg} de Dano!). Mantenha mana guardada para barreiras ou feitiços de cura.`;
      tacticalTipEn = `Watch out for "${highestThreatSpell.name}" (${highestThreatSpell.dmg} Damage!). Keep mana saved for shields or healing.`;
    } else if (highestHealSpell) {
      tacticalTip = `O oponente pode se curar com ${(lang === "pt" && highestHealSpell.name_pt) ? highestHealSpell.name_pt : highestHealSpell.name}. Equipe feitiços de dano concentrado para neutralizá-lo rapidamente.`;
      tacticalTipEn = `The opponent has healing spells. Equip burst damage spells to overwhelm them quickly.`;
    } else {
      tacticalTip = `Confronto equilibrado. Ajuste seu grimório para manter uma combinação balanceada de dano, escudos e geração de mana.`;
      tacticalTipEn = `Balanced confrontation. Tune your grimoire with a steady mix of damage, shields, and mana generation.`;
    }

    const timerPct = Math.max(0, Math.min(100, (loadoutCountdown / LOADOUT_DURATION) * 100));
    const isUrgent = loadoutCountdown <= 5;
        ...
        <div className="relative z-10 game-container min-h-full sm:h-full flex flex-col justify-between">
          ...
          <div className="w-full flex flex-col items-center py-1 flex-shrink-0">
            <div className="w-full flex items-center justify-between gap-2 px-1 mb-1">
              <div
                className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-[11px] font-mono border shadow-sm"
                style={{ borderColor: `${T.success}66`, background: `${T.success}18`, color: T.success }}
              >
              ...
              <div
                ...
                style={{ borderColor: `${T.gold}66`, background: `${T.gold}18`, color: T.gold }}
              >
                <span>⚡</span><span>{t("loadoutPhase")}</span>
              </div>
            </div>

            {/* Countdown Banner with Progress Bar & Controls */}
            <div
              className={`w-full rounded-2xl border p-2 sm:p-2.5 flex flex-col gap-1.5 transition-all shadow-lg ${
                isUrgent
                  ? "bg-rose-950/40 border-rose-500/80 shadow-[0_0_20px_rgba(244,63,94,0.3)] animate-pulse"
                  : "bg-slate-900/85 border-amber-400/30"
              }`}
            >
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center font-mono font-black text-sm sm:text-base border shadow-inner ${
                      isUrgent
                        ? "bg-rose-600 text-white border-rose-400 shadow-[0_0_12px_rgba(244,63,94,0.8)]"
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-serif font-bold text-xs sm:text-sm text-zinc-200">
                        {t("loadoutTimer")}
                      </span>
                      {isUrgent && (
                        <span className="text-[10px] font-mono font-bold text-rose-400 uppercase tracking-wide animate-ping">
                          {t("timeExpiring")}
                        </span>
                      )}
                    </div>
                    <div className="text-[10px] font-mono text-zinc-400">
                      {lang === "pt" ? "Analise o oponente e ajuste seus feitiços e itens antes do duelo!" : "Analyze the opponent and tweak spells and items before the duel!"}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  <div
                    className={`px-3 py-1 rounded-xl font-mono font-black text-base sm:text-lg border ${
                      isUrgent
                        ? "bg-rose-500/25 border-rose-400 text-rose-300 shadow-[0_0_10px_rgba(244,63,94,0.5)]"
                  ...
                  <button
                    type="button"
                    onClick={toggleLoadoutPause}
                    className="px-2 py-1 rounded-lg text-[10px] font-mono font-bold border border-white/20 bg-white/5 hover:bg-white/10 text-zinc-200 transition-all flex items-center gap-1 cursor-pointer"
                    title={loadoutTimerPaused ? t("resume") : t("pause")}
                  >
                    <span>{loadoutTimerPaused ? "▶️" : "⏸️"}</span>
                    <span className="hidden sm:inline">{loadoutTimerPaused ? t("resume") : t("pause")}</span>
                  </button>

                  <button
                    type="button"
                    onClick={() => addLoadoutTime(10)}
                    className="px-2 py-1 rounded-lg text-[10px] font-mono font-bold border border-amber-400/30 bg-amber-400/10 hover:bg-amber-400/20 text-amber-300 transition-all flex items-center gap-0.5 cursor-pointer"
                    title="+10s de preparação"
                  >
                    <span>⏳</span>
                    <span>+10s</span>
                  </button>
              ...
              <div className="w-full h-1.5 bg-black/50 rounded-full overflow-hidden border border-white/10">
                <div
                  className={`h-full transition-all duration-1000 ease-linear rounded-full ${
                    isUrgent
                      ? "bg-gradient-to-r from-rose-600 to-rose-400 shadow-[0_0_10px_rgba(244,63,94,0.9)]"
                      : loadoutCountdown <= 10
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center justify-center gap-1.5 mt-1.5 flex-wrap">
                    <button
                      onClick={() => setTab("skills")}
                      className="px-2 py-0.5 rounded-full text-[10px] font-mono font-bold border transition-all hover:scale-105 flex items-center gap-1 shadow-sm cursor-pointer"
                      style={{ borderColor: `${playerEl.color}88`, background: `${playerEl.color}1e`, color: playerEl.color }}
                      title="Clique para abrir o Grimório completo e escolher seus feitiços"
                    >
                      <span>📖</span>
                    ...
                    <button
                      onClick={() => setTab("gear")}
                      className="px-2 py-0.5 rounded-full text-[10px] font-mono font-bold border border-white/20 bg-white/5 hover:bg-white/10 text-zinc-300 hover:text-white transition-all hover:scale-105 flex items-center gap-1 shadow-sm cursor-pointer"
                      title={t("gearTitle")}
                    >
                      <span>🛡️</span>
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center justify-center gap-1.5 mt-1.5 flex-wrap">
                    ...
                    <button
                      onClick={() => setShowEnemyGearModal(true)}
                      className="px-2 py-0.5 rounded-full text-[10px] font-mono font-bold border border-sky-400/40 bg-sky-500/15 hover:bg-sky-500/25 text-sky-200 transition-all hover:scale-105 flex items-center gap-1 shadow-sm cursor-pointer"
                      title={lang === "pt" ? "Ver todos os equipamentos e mascote do oponente" : "View opponent equipment and companion"}
                    >
                      <span>🔍</span>
                      <span>{lang === "pt" ? "Equipamentos" : "Gear"}</span>
                    </button>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full rounded-2xl panel-base p-2.5 sm:p-3 border shadow-md flex flex-col gap-2" style={{ borderColor: `${T.gold}44` }}>
              <div className="flex items-center justify-between flex-wrap gap-2 text-xs font-mono">
                <span className="font-bold font-serif text-sm flex items-center gap-1.5" style={{ color: T.gold }}>
                  <span>👁️</span>
                  <span>{t("tacticalIntel")}</span>
                </span>
                
                {/* Elemental Advantage Badge */}
                {playerCountersEnemy && (
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-500/50 flex items-center gap-1 shadow-sm">
                    <span>⚔️</span>
                    <span>{t("elementalAdvantage")} (+25% Dano)</span>
                  </span>
                )}
                {enemyCountersPlayer && (
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-rose-500/20 text-rose-300 border border-rose-500/50 flex items-center gap-1 shadow-sm animate-pulse">
                    <span>⚠️</span>
                    <span>{t("elementalDisadvantage")}</span>
                  </span>
                )}
                {isSameAffinity && (
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-sky-500/20 text-sky-300 border border-sky-500/50 flex items-center gap-1 shadow-sm">
                    <span>⚖️</span>
                    <span>{lang === "pt" ? "Duelo Espelhado" : "Mirror Duel"}</span>
                  </span>
                )}
                {!playerCountersEnemy && !enemyCountersPlayer && !isSameAffinity && (
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-zinc-800/80 text-zinc-300 border border-white/10 flex items-center gap-1 shadow-sm">
                    <span>✦</span>
              ...
              {highestThreatSpell && (
                <div className="flex items-center justify-between gap-2 p-1.5 sm:p-2 rounded-xl bg-black/30 border border-white/5 text-[11px] font-mono">
                  <div className="flex items-center gap-1.5 min-w-0 truncate">
                    <span className="text-rose-400 font-bold">🔥 {t("highestThreat")}:</span>
                    <span className="font-serif font-bold text-zinc-200 truncate">
                      {(lang === "pt" && highestThreatSpell.name_pt) ? highestThreatSpell.name_pt : highestThreatSpell.name}
                    </span>
                    <span className="text-zinc-400 hidden xs:inline">·</span>
                    <span className="text-rose-400 font-bold hidden xs:inline">⚔️ {highestThreatSpell.dmg} DMG</span>
                    <span className="text-cyan-400 font-bold hidden sm:inline">💧 {highestThreatSpell.mana} MANA</span>
                  </div>
                  <button
                    type="button"
                    onClick={() => setInspectedBattleSkill(highestThreatSpell)}
                    className="text-[10px] font-mono text-amber-300 hover:text-amber-200 underline font-semibold flex-shrink-0 cursor-pointer"
                  >
                    🔍 {lang === "pt" ? "Ver Feitiço" : "Inspect"}
                  </button>
                </div>
              )}

              {/* Counter-Strategy Recommendation Box */}
              <div className="p-2 sm:p-2.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-[11px] font-mono flex items-start gap-2">
                <span className="text-base flex-shrink-0">💡</span>
                <div>
                  <span className="font-bold text-amber-300 mr-1">{t("counterStrategy")}:</span>
                  <span className="text-zinc-300 leading-relaxed">
                    {lang === "pt" ? tacticalTip : tacticalTipEn}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap flex-shrink-0">
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  <button
                    onClick={() => setTab("skills")}
                    className="btn-surface rounded-lg px-2.5 py-1 text-[11px] font-mono font-bold text-amber-300 border border-amber-400/30 hover:border-amber-400/70 hover:bg-amber-400/10 transition-all flex items-center gap-1 shadow-sm cursor-pointer"
                  ...
                  <button
                    onClick={() => setTab("gear")}
                    className="btn-surface rounded-lg px-2.5 py-1 text-[11px] font-mono font-bold text-zinc-300 hover:text-white transition-all flex items-center gap-1 shadow-sm cursor-pointer"
                    title={t("gearTitle")}
                  >
                    <span>🛡️</span>
                    <span>{t("gear")}</span>
                  ...
                  <button
                    ...
                    className="btn-surface rounded-lg px-2.5 py-1 text-[11px] font-mono font-bold text-emerald-300 border border-emerald-500/30 hover:bg-emerald-500/10 transition-all flex items-center gap-1 shadow-sm cursor-pointer"
                    title={lang === "pt" ? "Ver e preparar Poções de Batalha" : "Inspect Battle Potions"}
                  >
                    <span>🎒</span>
                    <span>{lang === "pt" ? "Poções" : "Potions"}</span>
                  </button>
                </div>
              </div>

              {/* View 1: Both (Side-by-Side Comparison & Fast Loadout) */}
              {scoutView === "both" && (
                <div className="flex flex-col gap-2.5 w-full">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 w-full">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2 text-[11px] font-mono">
                          <span className="font-bold flex items-center gap-1.5" style={{ color: playerEl.color }}>
                            <span>🧙‍♂️</span>
                            <span>Seu Deck ({playerSkills.length}/{maxSlots})</span>
                          </span>
                          <button
                            onClick={() => setTab("skills")}
                            className="text-[10px] font-mono text-amber-300/90 hover:text-amber-200 underline font-semibold cursor-pointer"
                          >
                            + Grimório
                          </button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-1.5">
                          {playerSkills.map(s => {
                            const e = ELEMENTS[s.el] || ELEMENTS.arcane;
                            const sName = (lang === "pt" && s.name_pt) ? s.name_pt : s.name;
                            return (
                              <div
                                key={s.id}
                                onClick={() => setInspectedBattleSkill(s)}
                                className="card-surface rounded-xl border p-1.5 sm:p-2 flex flex-col justify-between shadow-sm relative group hover:border-amber-400/60 cursor-pointer transition-all"
                                style={{ borderColor: `${e.color}55` }}
                                title={lang === "pt" ? "Clique para inspecionar feitiço" : "Click to inspect spell"}
                              >
                                <div className="flex items-center justify-between gap-1 mb-1">
                                  ...
                                  <div className="flex items-center gap-1 flex-shrink-0">
                                    ...
                                    <button
                                      ...
                                      className="w-4 h-4 rounded-full flex items-center justify-center text-[9px] font-bold bg-black/50 hover:bg-rose-500/90 text-zinc-400 hover:text-white transition-all disabled:opacity-30 disabled:pointer-events-none cursor-pointer"
                          ...
                          {Array.from({ length: Math.max(0, maxSlots - playerSkills.length) }).map((_, idx) => (
                            <button
                              key={`empty-slot-${idx}`}
                              onClick={() => setTab("skills")}
                              className="rounded-xl border-2 border-dashed border-white/15 hover:border-amber-400/60 p-2 flex flex-col items-center justify-center text-center transition-all bg-white/[0.02] hover:bg-amber-400/[0.05] min-h-[46px] cursor-pointer"
                            >
                    ...
                    <div className="rounded-2xl panel-base p-2.5 sm:p-3 border shadow-md flex flex-col justify-between" style={{ borderColor: `${enemyEl.color}44` }}>
                      <div>
                        <div className="flex items-center justify-between mb-2 text-[11px] font-mono">
                          ...
                          <div className="flex gap-1.5">
                            <button
                              ...
                              className="btn-surface rounded-lg px-2 py-0.5 text-[10px] font-mono transition-all cursor-pointer"
                            >
                              💬 Conversar
                            </button>
                            <button
                              ...
                              disabled={friended}
                              className="btn-surface rounded-lg px-2 py-0.5 text-[10px] font-mono transition-all font-bold cursor-pointer"
                              style={{
                          ...
                          {foeSkills.map(s => {
                            ...
                            return (
                              <div
                                key={s.id}
                                onClick={() => setInspectedBattleSkill(s)}
                                className="card-surface rounded-xl border p-1.5 sm:p-2 flex flex-col justify-between shadow-sm hover:border-sky-400/60 cursor-pointer transition-all"
                                style={{ borderColor: `${e.color}55` }}
                                title={lang === "pt" ? "Clique para inspecionar feitiço do oponente" : "Click to inspect enemy spell"}
                              >
                                <div className="flex items-center justify-between gap-1 mb-1">
                                  <span className="font-serif text-[11px] sm:text-[12px] font-bold text-[#FAF6EE] leading-tight truncate">
                                    {sName}
                        ...
                        {/* Enemy Gear Quick Summary */}
                        <div
                          onClick={() => setShowEnemyGearModal(true)}
                          className="mt-2 p-1.5 sm:p-2 rounded-xl bg-black/35 border border-white/10 hover:border-sky-400/50 cursor-pointer transition-all flex items-center justify-between gap-2 text-[10px] font-mono group"
                          title={lang === "pt" ? "Clique para ver detalhes completos dos equipamentos" : "Click to view full gear details"}
                        >
                          <div className="flex items-center gap-1.5 min-w-0 truncate text-zinc-300">
                            <span>🪄</span>
                            <span className="truncate font-semibold" style={{ color: RARITY[enemy.staffGear?.rarity || "common"]?.color }}>{enemy.staffGear?.name}</span>
                            {enemy.relic && <span className="truncate text-amber-300">· ✦ {enemy.relic.name}</span>}
                            {enemy.pet && <span className="truncate text-emerald-300">· 🐾 {(lang === "pt" && enemy.pet.name_pt) ? enemy.pet.name_pt : enemy.pet.name}</span>}
                            {enemy.offhand && <span className="truncate text-sky-300">· 🛡️ {enemy.offhand.name}</span>}
                          </div>
                          <span className="text-sky-300 font-bold group-hover:underline flex-shrink-0 flex items-center gap-0.5">
                            <span>🔍</span>
                            <span className="hidden sm:inline">{lang === "pt" ? "Ver Equipamentos" : "View Gear"}</span>
                          </span>
                        </div>
                      </div>
                  ...
                  {/* Fast In-Screen Spell Swapper Rack */}
                  {availableSpells.length > 0 && (
                    <div className="rounded-2xl panel-base p-2.5 border border-amber-500/30 bg-slate-950/70 shadow-md">
                      <div className="flex items-center justify-between gap-2 mb-1.5 text-[11px] font-mono">
                        <span className="font-bold text-amber-300 flex items-center gap-1">
                          <span>⚡</span>
                          <span>{t("quickSpells")} ({availableSpells.length})</span>
                        </span>
                        ...
                        {availableSpells.map(s => {
                          ...
                          return (
                            <button
                              key={s.id}
                              type="button"
                              onClick={() => quickEquipOrReplace(s.id)}
                              className="card-surface rounded-xl border p-1.5 flex-shrink-0 min-w-[130px] sm:min-w-[145px] flex flex-col justify-between hover:border-amber-400/80 hover:bg-amber-400/10 transition-all text-left group cursor-pointer shadow-sm"
                              style={{ borderColor: `${e.color}44` }}
                              title={`${sName} - ${t("tapToEquip")}`}
                            >
                              <div className="flex items-center justify-between gap-1 w-full mb-0.5">
                                <span className="font-serif text-[11px] font-bold text-zinc-100 truncate group-hover:text-amber-200">
                                  {sName}
                                </span>
                                <span className="text-[11px] flex-shrink-0" style={{ color: e.color }}>{e.icon}</span>
                              </div>
                              ...
                              <div className="mt-1 text-[8.5px] font-mono text-amber-400/80 group-hover:text-amber-300 flex items-center gap-0.5">
                                <span>+</span><span>Equipar</span>
                              </div>
                            </button>
                          );
                        })}
                  ...
                  {/* Fast In-Screen Gear Swapper Rack */}
                  <div className="rounded-2xl panel-base p-2.5 border border-white/10 bg-slate-950/70 shadow-md">
                    <div className="flex items-center justify-between gap-2 mb-1.5 text-[11px] font-mono">
                      <span className="font-bold text-zinc-200 flex items-center gap-1">
                        <span>🛡️</span>
                        <span>{t("quickGear")}</span>
                      </span>
                      <button
                        onClick={() => setTab("gear")}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                      {/* Staff Selector */}
                      <div className="flex flex-col gap-1 p-1.5 rounded-xl bg-black/40 border border-white/5">
                        <span className="text-[9.5px] font-mono text-zinc-400 uppercase tracking-wider flex items-center gap-1">
                          <span>🪄</span><span>Cajado</span>
                        </span>
                        <select
                          value={staffId}
                          onChange={(e) => setStaffId(e.target.value)}
                          className="w-full bg-slate-900 border border-amber-400/30 rounded-lg p-1 text-[11px] font-mono text-zinc-200 cursor-pointer focus:outline-none focus:border-amber-400"
                        >
                          {ownedStaffs.map(st => (
                      ...
                      <div className="flex flex-col gap-1 p-1.5 rounded-xl bg-black/40 border border-white/5">
                        <span className="text-[9.5px] font-mono text-zinc-400 uppercase tracking-wider flex items-center gap-1">
                          <span>🛡️</span><span>Item Secundário</span>
                        </span>
                        <select
                          value={offhandId}
                          onChange={(e) => setOffhandId(e.target.value)}
                          className="w-full bg-slate-900 border border-amber-400/30 rounded-lg p-1 text-[11px] font-mono text-zinc-200 cursor-pointer focus:outline-none focus:border-amber-400"
                        >
                          {ownedOffhands.map(oh => (
                ...
                <div className="w-full rounded-2xl panel-base p-2.5 sm:p-3.5 border shadow-md flex flex-col gap-2.5" style={{ borderColor: `${playerEl.color}55` }}>
                  <div className="flex items-center justify-between flex-wrap gap-2 text-[12px] font-mono">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => setTab("skills")}
                        className="btn-surface rounded-xl px-3 py-1 text-[11px] font-mono font-bold text-amber-300 border border-amber-400/40 hover:bg-amber-400/10 transition-all flex items-center gap-1 shadow-sm cursor-pointer"
                      >
                        <span>📖</span>
                      ...
                      <button
                        onClick={() => setTab("gear")}
                        className="btn-surface rounded-xl px-3 py-1 text-[11px] font-mono font-bold text-zinc-300 hover:text-white transition-all flex items-center gap-1 shadow-sm cursor-pointer"
                      >
                        <span>🛡️</span>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                    {playerSkills.map(s => {
                      ...
                      return (
                        <div
                          key={s.id}
                          onClick={() => setInspectedBattleSkill(s)}
                          className="card-surface rounded-xl border p-2 flex flex-col justify-between shadow-sm relative group hover:border-amber-400/50 transition-all cursor-pointer"
                          style={{ borderColor: `${e.color}55` }}
                        >
                          <div>
                            <div className="flex items-center justify-between gap-1 mb-1">
                          ...
                          <div>
                            ...
                            <button
                              ...
                              disabled={chosen.length <= 1}
                              className="w-full py-1 rounded-lg text-[10px] font-mono font-bold bg-rose-500/10 hover:bg-rose-500/20 text-rose-300 border border-rose-500/30 transition-all disabled:opacity-30 disabled:pointer-events-none flex items-center justify-center gap-1 cursor-pointer"
                            >
                              <span>✕</span>
                    ...
                    {Array.from({ length: Math.max(0, maxSlots - playerSkills.length) }).map((_, idx) => (
                      <button
                        ...
                        onClick={() => setTab("skills")}
                        className="rounded-xl border-2 border-dashed border-white/20 hover:border-amber-400/60 p-3 flex flex-col items-center justify-center text-center transition-all bg-white/[0.02] hover:bg-amber-400/[0.05] min-h-[100px] cursor-pointer"
                      >
                  ...
                  {/* Fast Spell Swapper in Player View */}
                  {availableSpells.length > 0 && (
                    <div className="rounded-2xl panel-base p-2.5 border border-amber-500/30 bg-slate-950/70 shadow-md mt-1">
                      <div className="flex items-center justify-between gap-2 mb-1.5 text-[11px] font-mono">
                        <span className="font-bold text-amber-300 flex items-center gap-1">
                          <span>⚡</span>
                          <span>{t("unlockedSpellsBank")} ({availableSpells.length})</span>
                        </span>
                        <span className="text-[10px] text-zinc-400">
                          {t("tapToEquip")}
                        </span>
                ...
                <div className="w-full rounded-2xl panel-base p-2.5 sm:p-3.5 border shadow-md flex flex-col gap-2.5" style={{ borderColor: `${enemyEl.color}55` }}>
                  <div className="flex items-center justify-between flex-wrap gap-2 text-[12px] font-mono">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <button
                        onClick={() => setShowEnemyGearModal(true)}
                        className="btn-surface rounded-lg px-2.5 py-1 text-[11px] font-mono transition-all font-bold text-sky-300 border-sky-400/40 hover:bg-sky-400/15 flex items-center gap-1 shadow-sm cursor-pointer"
                        title={lang === "pt" ? "Inspecionar todos os equipamentos e mascote do oponente" : "Inspect all opponent equipment and pet"}
                      >
                        <span>🔍</span>
                        <span>{lang === "pt" ? "Equipamentos" : "Gear"}</span>
                      </button>
                      <button
                        onClick={() => openChat(enemy)}
                        className="btn-surface rounded-lg px-2.5 py-1 text-[11px] font-mono transition-all flex items-center gap-1 cursor-pointer"
                      >
                        💬 Conversar
                      </button>
                      <button
                        onClick={() => addFriend(enemy)}
                        disabled={friended}
                        className="btn-surface rounded-lg px-2.5 py-1 text-[11px] font-mono transition-all font-bold cursor-pointer"
                        style={{
                          borderColor: friended ? `${T.success}88` : undefined,
                          color: friended ? T.success : undefined,
                        }}
                  ...
                  <div className="p-2.5 rounded-xl bg-black/30 border border-white/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-[11px] font-mono">
                    ...
                    <button
                      type="button"
                      onClick={() => setShowEnemyGearModal(true)}
                      className="text-[10px] font-mono text-zinc-400 sm:text-right flex-shrink-0 cursor-pointer hover:text-sky-300 transition-colors flex items-center gap-1 group"
                      title={lang === "pt" ? "Clique para inspecionar todos os equipamentos" : "Click to inspect all gear"}
                    >
                      <span>Cajado: <span className="text-zinc-200 font-bold group-hover:underline">{enemy.staffGear?.name}</span></span>
                      <span className="text-sky-400 font-bold underline ml-1">[🔍 {lang === "pt" ? "Inspecionar" : "Inspect"}]</span>
                    </button>
                  </div>
                    ...
                    {foeSkills.map(s => {
                      ...
                      return (
                        <div
                          key={s.id}
                          onClick={() => setInspectedBattleSkill(s)}
                          className="card-surface rounded-xl border p-2 flex flex-col justify-between shadow-sm transition-all cursor-pointer hover:border-sky-400/50"
                          style={{ borderColor: `${e.color}55` }}
                        >
                          <div>
                            <div className="flex items-center justify-between gap-1 mb-1">
          ...
          {/* Bottom Action Bar: Navigation and Primary Ready Button with Live Countdown */}
          <div className="w-full flex items-center gap-2 pt-1.5 pb-0.5 flex-shrink-0">
            <button
              onClick={() => setPhase("loadout")}
              className="btn-surface rounded-xl px-3 py-2.5 font-serif text-[11px] sm:text-[13px] font-bold transition-all flex items-center justify-center gap-1 flex-shrink-0 cursor-pointer"
              title={t("backHub")}
            >
              <span>←</span>
              <span>{t("backHub")}</span>
            ...
            >
              <span>🔄</span>
              <span className="hidden xs:inline">{t("newOpponent")}</span>
            </button>
            <button
              onClick={confirmDuel}
              disabled={!canEnterArena}
              className={`btn-gold flex-1 rounded-xl py-2.5 px-3 sm:px-6 font-serif text-[13px] sm:text-[16px] font-black shadow-xl transition-all flex items-center justify-center gap-2 cursor-pointer ${
                !canEnterArena
                  ? "opacity-50 cursor-not-allowed filter grayscale"
                  : isUrgent
                  ? "animate-pulse ring-2 ring-rose-400 shadow-[0_0_24px_rgba(244,63,94,0.6)]"
                  : "hover:brightness-110 active:scale-95"
              }`}
              title={!canEnterArena ? (lang === "pt" ? "Equipe ao menos 4 feitiços para iniciar o duelo" : "Equip at least 4 spells to start duel") : t("readyForBattle")}
            >
              <span>⚔️</span>
              <span>{t("readyForBattle")}</span>
              <span className="px-2 py-0.5 rounded-lg bg-black/30 text-amber-200 text-xs font-mono font-bold border border-amber-400/30">
                {loadoutCountdown}s
              </span>
            </button>
          </div>
  ...
  if (phase === "result") {
    ...
    return (
      <div className="min-h-[100dvh] h-full overflow-y-auto custom-scrollbar relative flex items-center justify-center safe-all p-2 sm:p-3" style={{ color: T.textPrimary }}>
        {styles}{bg}
        <div
  ...
  // ================= BATTLE =================
  const menuSkills = player.skills;
  const shakeClass = screenShake === "heavy" ? "arena-shake-heavy" : screenShake === "light" ? "arena-shake-light" : "";

  return (
    <div className={`h-[100dvh] max-h-[100dvh] overflow-hidden relative flex flex-col items-center justify-between safe-all p-1 sm:p-2.5 md:p-4 ${shakeClass}`} style={{ color: "#FFFFFF" }}>
      {styles}{bg}
      ...
      <div className="relative z-10 game-container h-full flex flex-col justify-between overflow-hidden min-h-0">
        ...
        <TurnCountdownBar
          ...
          maxDuration={getTodayModifier().id === "swift_duels" ? 14 : TURN_DURATION}
          roundNum={roundNum}
          currentTurn={currentTurn}
